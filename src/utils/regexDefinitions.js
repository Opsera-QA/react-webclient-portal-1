...
regexDefinitions.customParameterValueRegex = {
  regex: /^[a-zA-Z0-9-+|!.*$@&:_,; [\]\\/]*$/,
  formText: "Values are visible to all users if no Access Rules are assigned to this record. Value can be up to 16,000 characters and contain alphanumeric characters, spaces, and these symbols: @ ! & + * - _ / \\ . $ [ ] : , ; |",
  errorFormText: "Values are visible to all users if no Access Rules are assigned to this record. Value can be up to 16,000 characters and contain alphanumeric characters, spaces, and these symbols: @ ! & + * - _ / \\ . $ [ ] : , ; |",
  isRequiredFunction: (model) => {
    return (model != null && model.getData("vaultEnabled") !== true);
  },
};
