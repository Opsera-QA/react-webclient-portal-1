...
function CodeCategoriesPieChart2({ data, persona }) {
  ...
  return (
    <>
      <ModalLogs
        header="Code Categories (Keyword = OK)"
        size="lg"
        jsonMessage={sonarCodeCategoriesOK ? sonarCodeCategoriesOK.data : []}
        dataType="pie"
        show={showModal}
      ...
      <div className="chart mb-3" style={{ height: "300px" }}>
        ...
        {typeof data !== "object" || Object.keys(data).length === 0 || sonarCodeCategoriesOK.status !== 200 ? (
          <div
