      ...
      <div className="d-flex flex-column mb-3">
        <div className="metric-box p-3 text-center">
          <blockquote className="blockquote mb-0 ">
            <div className="box-metric">{xunitExecuted && Object.keys(xunitExecuted.data[0]).length > 0 ? Object.values(xunitExecuted.data[0]) : null}</div>
          ...
          <blockquote className="blockquote mb-0 ">
            ...
            <div className={"box-metric " + (xunitPassed && Object.keys(xunitPassed.data[0]).length > 0 && Object.keys(xunitExecuted.data[0]).length > 0 && xunitPassed.data[0]/xunitExecuted.data[0]*100 > 80 ? "green" : "red" )}>{xunitPassed ? (xunitPassed.data[0]/xunitExecuted.data[0])*100 + "%" : null}</div>
            <footer className="blockquote">
              <div className="metric-box-subtext text-muted">
              Pass Percentage
              </div>
        ...
        <div className="metric-box p-3 mt-3 text-center">
          <blockquote className="blockquote mb-0 ">
            <div className={"box-metric " + (xunitFailed && Object.keys(xunitFailed.data[0]).length > 0 ? "red" : null)}>
              {xunitFailed && Object.keys(xunitFailed.data[0]).length > 0 ? Object.values(xunitFailed.data[0]) : null}</div>
            <footer className="blockquote">
              <div className="metric-box-subtext text-muted">
            Tests Failed
              </div>
          ...
          <blockquote className="blockquote mb-0 ">
            <div className="box-metric">{xunitSkipped && Object.keys(xunitSkipped.data[0]).length > 0 ? Object.values(xunitSkipped.data[0]) : null}</div>
            <footer className="blockquote">
              <div className="metric-box-subtext text-muted">
              Tests Skipped
              </div>
          ...
          <blockquote className="blockquote mb-0 ">
            <div className={"box-metric " + (xunitError && Object.keys(xunitError.data[0]).length > 0 ? "red" : null)}>
              {xunitError  && Object.keys(xunitError.data[0]).length > 0 ? Object.values(xunitError.data[0]) : null}</div>
            <footer className="blockquote">
              <div className="metric-box-subtext text-muted">
            Tests Errored
              </div>
