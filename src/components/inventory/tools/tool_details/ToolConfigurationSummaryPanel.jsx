...
import JenkinsToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/jenkins/JenkinsToolConfigurationSummaryPanel";
...
import JiraToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/jira/JiraToolConfigurationSummaryPanel";
...
import GithubToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/github/GithubToolConfigurationSummaryPanel";
...
import GitlabToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/gitlab/GitlabToolConfigurationSummaryPanel";
import BitbucketToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/bitbucket/BitbucketToolConfigurationSummaryPanel";
import bitbucketConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/bitbucket/bitbucket-connection-metadata";
import SpinnakerToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/spinnaker/SpinnakerToolConfigurationSummaryPanel";
import spinnakerConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/spinnaker/spinnaker-connection-metadata";
import CypressToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/cypress/CypressToolConfigurationSummaryPanel";
import cypressConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/cypress/cypress-connection-metadata";
import ArgoToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/argo/ArgoToolConfigurationSummaryPanel";
import argoConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/argo/argo-connection-metadata";
import AnchoreScanToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/anchore_scan/AnchoreScanToolConfigurationSummaryPanel";
import anchoreScanConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/anchore_scan/anchore-scan-connection-metadata";
import AnchoreIntegratorToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/anchore_integrator/AnchoreIntegratorToolConfigurationSummaryPanel";
import anchoreIntegratorConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/anchore_integrator/anchore-integrator-connection-metadata";
import SonarToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/sonar/SonarToolConfigurationSummaryPanel";
import sonarConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/sonar/sonar-connection-metadata";
import AwsToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/aws/AwsToolConfigurationSummaryPanel";
import awsConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/aws/aws-connection-metadata";
import SfdcToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/sfdc/SfdcToolConfigurationSummaryPanel";
import sfdcConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/sfdc/sfdc-connection-metadata";
import NexusToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/nexus/NexusToolConfigurationSummaryPanel";
...
import TeamsToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/teams/TeamsToolConfigurationSummaryPanel";
import OctopusToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/octopus/OctopusToolConfigurationSummaryPanel";
import octopusConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/octopus/octopus-connection-metadata";
import SlackToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/slack/SlackToolConfigurationSummaryPanel";
import AzureToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/azure/AzureToolConfigurationSummaryPanel";
import AzureConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/azure/azure-connection-metadata";
import AzureDevopsToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/azure-devops/AzureDevopsToolConfigurationSummaryPanel";
...
import JFrogToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/jfrog_artifactory/JFrogToolConfigurationSummaryPanel";
import jfrogConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/jfrog_artifactory/jfrog-connection-metadata";
import ServiceNowToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/service_now/ServiceNowToolConfigurationSummaryPanel";
import serviceNowConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/service_now/service-now-connection-metadata";
import HashicorpVaultToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/hashicorp_vault/HashicorpVaultToolConfigurationSummaryPanel";
import HashicorpVaultConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/hashicorp_vault/hashicorpVault-connection-metadata";
import KafkaConnectToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/kafka_connect/KafkaConnectToolConfigurationSummaryPanel";
import KafkaConnectConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/kafka_connect/kafkaConnect-connection-metadata";
import CoverityToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/coverity/CoverityToolConfigurationSummaryPanel";
import CoverityConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/coverity/coverity-connection-metadata";
import TwistlockToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/twistlock/TwistlockToolConfigurationSummaryPanel";
import TwistlockConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/twistlock/twistlock-connection-metadata";
import mongodbeRealmConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/mongodb_realm/mongodb-realm-connection-metadata";
import MongodbRealmToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/mongodb_realm/MongodbRealmToolConfigurationSummaryPanel";
...
import FlywayDatabaseToolConnectionSummaryPanel from "components/inventory/tools/details/identifiers/flyway_database/FlywayDatabaseToolConnectionSummaryPanel";
import { flywayDatabaseToolConnectionMetadata } from "components/inventory/tools/details/identifiers/flyway_database/flywayDatabaseToolConnection.metadata";
import InformaticaIdqConnectionMetadata from "./tool_jobs/informatica_idq/informatica-idq-connection-metadata";
import InformaticaIdqToolConfigurationSummaryPanel from "./tool_jobs/informatica_idq/InformaticaIdqToolConfigurationSummaryPanel";
import ToolConnectionSummaryContainer from "components/inventory/tools/details/connection/ToolConnectionSummaryContainer";
import gchatConnectionMetadata from "components/inventory/tools/tool_details/tool_jobs/gchat/gchat-connection-metadata";
import GChatToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/gchat/GChatToolConfigurationSummaryPanel";
import FortifyToolConfigurationSummaryPanel from "components/inventory/tools/tool_details/tool_jobs/fortify/FortifyToolConfigurationSummaryPanel";
