...
function ToolJobsPanel({ toolData, loadData }) {
  ...
  const getJobsPanel = (toolIdentifier, loadData) => {
    switch (toolIdentifier) {
      ...
      default:
        return <div className="text-center p-5 text-muted mt-5">Opsera jobs management is not currently available for this tool.</div>
    }
  }
  ...
  return (
    <>
      <div className="text-muted p-2">
        ...
        <div className="mb-3"><span>Create settings for custom jobs to be triggered in Pipeline steps (when configuring a pipeline). These settings can be entered once and reused across the Opsera platform.</span></div>
