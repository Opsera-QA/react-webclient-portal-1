...
import ToolJobsTab, {JOBS_SUPPORTED_TOOL_IDENTIFIERS} from "components/inventory/tools/tool_details/tab_container/tabs/ToolJobsTab";
import ToolVaultTab, {VAULT_SUPPORTED_TOOL_IDENTIFIERS} from "components/inventory/tools/tool_details/tab_container/tabs/ToolVaultTab";
import ToolAccountsTab, {ACCOUNT_SUPPORTED_TOOL_IDENTIFIERS} from "components/inventory/tools/tool_details/tab_container/tabs/ToolAccountsTab";
import ToolLogsTab, {LOG_SUPPORTED_TOOL_IDENTIFIERS} from "components/inventory/tools/tool_details/tab_container/tabs/ToolLogsTab";
import ToolAttributesTab from "components/inventory/tools/tool_details/tab_container/tabs/ToolAttributesTab";
import ToolApplicationsTab, {APPLICATION_SUPPORTED_TOOL_IDENTIFIERS} from "components/inventory/tools/tool_details/tab_container/tabs/ToolApplicationsTab";
import ToolRepositoriesTab, {REPOSITORY_SUPPORTED_TOOL_IDENTIFIERS} from "components/inventory/tools/tool_details/tab_container/tabs/ToolRepositoriesTab";
import ToolConnectionTab from "components/inventory/tools/tool_details/tab_container/tabs/ToolConnectionTab";
import ToolProjectsTab, {PROJECT_SUPPORTED_TOOL_IDENTIFIERS} from "components/inventory/tools/tool_details/tab_container/tabs/ToolProjectsTab";
import ToolStorageTab, {STORAGE_SUPPORTED_TOOL_IDENTIFIERS} from "components/inventory/tools/tool_details/tab_container/tabs/ToolStorageTab";
import ToolUsageTab from "components/inventory/tools/tool_details/tab_container/tabs/ToolUsageTab";
import ToolServiceTypeMappingTab, {SERVICE_MAPPING_SUPPORTED_TOOL_IDENTIFIERS} from "components/inventory/tools/tool_details/tab_container/tabs/ToolServiceTypeMappingTab";
