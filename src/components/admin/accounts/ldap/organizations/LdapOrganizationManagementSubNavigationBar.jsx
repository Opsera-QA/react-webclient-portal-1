...
function LdapOrganizationManagementSubNavigationBar({activeTab}) {
...
LdapOrganizationManagementSubNavigationBar.propTypes = {
  activeTab: PropTypes.string,
};

export default LdapOrganizationManagementSubNavigationBar;
