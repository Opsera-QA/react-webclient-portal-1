...
kpiDataPointActions.getKpiDataPointsV2 = async (
  getAccessToken,
  cancelTokenSource,
  kpiId,
) => {
...
kpiDataPointActions.getKpiDataPointByIdentifiersV2 = async (
  getAccessToken,
  cancelTokenSource,
  kpiIdentifier,
  dataPointIdentifier,
...
kpiDataPointActions.createKpiDataPointV2 = async (
  getAccessToken,
  cancelTokenSource,
  kpiDataPointModel,
  kpiId,
...
kpiDataPointActions.updateKpiDataPointV2 = async (
  getAccessToken,
  cancelTokenSource,
  kpiDataPointModel,
  kpiId,
  ...
  const apiUrl = `analytics/kpi/${kpiId}/data-points/${kpiDataPointModel?.getData(
    "_id",
  )}/update`;
...
kpiDataPointActions.deleteKpiDataPointV2 = async (
  getAccessToken,
  cancelTokenSource,
  kpiDataPointModel,
  kpiId,
