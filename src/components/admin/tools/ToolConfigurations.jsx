          ...
          <Tabs defaultActiveKey="toolType" className="default-custom-tabs" id="uncontrolled-tab-example">
            <Tab eventKey="toolType" title="Tool Type">
              <div className="tabbed-content-block">
                ...
                {!isToolTypeLoading ? <ToolTypeTable selectedRow={rowData => selectedRow(rowData, "tool_type")}
                                                     data={toolTypeList}/> : null}
            ...
            <Tab eventKey="toolIdentifier" title="Tool Identifier">
              <div className="tabbed-content-block">
                ...
                {!isToolIdentifierLoading ?
                  <ToolIdentifierTable selectedRow={rowData => selectedRow(rowData, "tool_identifier")}
                                       data={toolIdentifierList}/> : null}
