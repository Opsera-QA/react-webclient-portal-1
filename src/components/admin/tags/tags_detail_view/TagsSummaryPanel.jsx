  ...
  return (
    <>
      {showDeleteModal && <Modal header="Confirm Tag Delete"
                                 ...
                                 handleConfirmModal={() => deleteTag(tagData)}/>}
          ...
          <div className="mb-3 flat-top-content-block p-3">
            <div className="mb-2 text-muted">
              <OverlayTrigger
                ...
                <FontAwesomeIcon icon={faTrash} className="delete-icon pointer red float-right ml-3" onClick={() => {
                  handleDeleteClick(tagData);
                }}/></OverlayTrigger>
            </div>
            ...
            <Row>
              <Col>
                <TextField label="Type" value={tagData.type}/>
              </Col>
              <Col>
