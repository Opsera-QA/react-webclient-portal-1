    ...
    return (
        <>
          <div className="flex-container-content mt-4">
            ...
            {rollBack && destructiveXml.length === 0 && <div className="my-3"><ErrorDialog error={"No Destructive XML found cannot proceed with empty package XML it on Rollback mode."}/></div> }
