...
function CommandLinePipelineStepV2SummaryPanel({ commandLinePipelineDataObject, pipelineData, setActiveTab }) {
...
CommandLinePipelineStepV2SummaryPanel.propTypes = {
...
export default CommandLinePipelineStepV2SummaryPanel;
