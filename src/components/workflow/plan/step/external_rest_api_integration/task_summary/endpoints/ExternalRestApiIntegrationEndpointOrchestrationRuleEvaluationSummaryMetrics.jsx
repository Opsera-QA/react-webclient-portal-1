...
export default function ExternalRestApiIntegrationEndpointOrchestrationRuleEvaluationSummaryMetrics(
  {
    ruleEvaluation,
...
ExternalRestApiIntegrationEndpointOrchestrationRuleEvaluationSummaryMetrics.propTypes = {
