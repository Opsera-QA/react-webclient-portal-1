  ...
  return (
    <Form>
      ...
      <Form.Group controlId="dockerName">
        ...
        <Form.Text className="text-muted">Must match the Jenkins Build step configuration.</Form.Text> 
      </Form.Group>
      ...
      {/* TODO: END OF Remove this block once back end supports ECR Push Step */}
      ...
      <Form.Group controlId="s3Step">
        ...
        <Form.Text className="text-muted">This step must know which Jenkins Build step is being used in order to retrieve the Docker Image URL generated by that step.  If this is not 
                selected properly the job may fail.</Form.Text> 
      </Form.Group>
