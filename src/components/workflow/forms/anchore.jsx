        ...
        <> {formData.anchoreUrl && formData.accountUsername ?
          <>
            ...
            <Form.Group controlId="s3Step">
              ...
              <Form.Text className="text-muted">This step must know which ECR Push step is being used in order to retrieve the Docker Image URL generated by that step.  If this is not 
