    ...
    <div>
      ...
      { typeof(stepTool) !== "undefined" ? 
        <div className="ml-1 mt-3">
          ...
          {editItem.tool_name.toLowerCase() === "elastic-beanstalk" ? <ElasticBeanstalkDeploy pipelineId={data._id} plan={data.workflow.plan} stepId={stepId} data={stepTool} parentCallback={callbackFunction} callbackSaveToVault={saveToVault} /> : null }
        </div>
        : null }
