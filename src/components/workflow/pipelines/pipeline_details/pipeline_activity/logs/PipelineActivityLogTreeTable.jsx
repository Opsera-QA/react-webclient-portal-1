...
function PipelineActivityLogTreeTable(
  ...
  const {
    logCount,
  } = useGetPollingPipelineActivityLogCountForRun(pipelineId, currentRunNumber === pipelineRunCount ? currentRunNumber : undefined);

  useEffect(() => {
    console.log("got new log count: " + logCount);
