...
function ServiceNowGroupByNameSelectInput({
  valueField,
  textField,
  fieldName,
  dataObject,
...
ServiceNowGroupByNameSelectInput.propTypes = {
...
ServiceNowGroupByNameSelectInput.defaultProps = {
  textField: "name",
  valueField: "_id",
};

export default ServiceNowGroupByNameSelectInput;
