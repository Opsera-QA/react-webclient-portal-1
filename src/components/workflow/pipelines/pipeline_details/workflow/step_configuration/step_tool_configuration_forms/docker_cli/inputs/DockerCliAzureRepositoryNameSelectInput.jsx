...
import azurePipelineActions from "components/workflow/pipelines/pipeline_details/workflow/step_configuration/step_tool_configuration_forms/azure_acr_push/azure-pipeline-actions";
import { hasStringValue } from "components/common/helpers/string-helpers";
import toolsActions from "components/inventory/tools/tools-actions";

function DockerCliAzureRepositoryNameSelectInput({
  model,
  setModel,
  disabled,
  acrLoginUrl,
...
DockerCliAzureRepositoryNameSelectInput.propTypes = {
...
export default DockerCliAzureRepositoryNameSelectInput;
