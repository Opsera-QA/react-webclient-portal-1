...
function ProvarBitbucketWorkspaceInput({dataObject, setDataObject, disabled}) {
...
ProvarBitbucketWorkspaceInput.propTypes = {
  dataObject: PropTypes.object,
  setDataObject: PropTypes.func,
  disabled: PropTypes.bool,
};

export default ProvarBitbucketWorkspaceInput;