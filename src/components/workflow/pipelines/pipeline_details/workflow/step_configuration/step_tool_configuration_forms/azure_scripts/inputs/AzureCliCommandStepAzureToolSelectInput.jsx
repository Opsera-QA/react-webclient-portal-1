...
function AzureCliCommandStepAzureToolSelectInput({ fieldName, model, setModel, disabled, setAzureConfig}) {
  ...
  const setDataFunction = (fieldName, selectedOption) => {
    ...
    newDataObject.setData("inlineCommand", "");
...
AzureCliCommandStepAzureToolSelectInput.propTypes = {
...
AzureCliCommandStepAzureToolSelectInput.defaultProps = {
  fieldName: "azureToolConfigId",
};

export default AzureCliCommandStepAzureToolSelectInput;
