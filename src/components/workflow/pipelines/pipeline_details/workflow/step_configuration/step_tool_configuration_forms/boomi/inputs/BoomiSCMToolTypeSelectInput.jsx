...
function BoomiSCMToolTypeSelectInput({dataObject, setDataObject, isLoading, disabled}) {
...
BoomiSCMToolTypeSelectInput.propTypes = {
...
export default BoomiSCMToolTypeSelectInput;