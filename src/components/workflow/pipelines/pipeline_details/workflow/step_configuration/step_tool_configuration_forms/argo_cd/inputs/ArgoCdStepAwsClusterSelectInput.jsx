...
function ArgoCdStepAwsClusterSelectInput({
  fieldName,
  model,
  setModel,
  disabled,
...
ArgoCdStepAwsClusterSelectInput.propTypes = {
...
ArgoCdStepAwsClusterSelectInput.defaultProps = {
  fieldName: "awsClusterName",
  textField: "awsClusterName",
  valueField: "awsClusterName",
};

export default ArgoCdStepAwsClusterSelectInput;
