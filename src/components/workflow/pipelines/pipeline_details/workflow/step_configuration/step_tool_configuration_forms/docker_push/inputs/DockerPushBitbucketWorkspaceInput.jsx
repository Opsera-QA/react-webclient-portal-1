...
function DockerPushBitbucketWorkspaceInput({dataObject, setDataObject, disabled}) {
...
DockerPushBitbucketWorkspaceInput.propTypes = {
  dataObject: PropTypes.object,
  setDataObject: PropTypes.func,
  disabled: PropTypes.bool,
};

export default DockerPushBitbucketWorkspaceInput;