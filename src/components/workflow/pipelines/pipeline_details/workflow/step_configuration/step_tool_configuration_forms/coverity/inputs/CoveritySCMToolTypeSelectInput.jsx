...
function CoveritySCMToolTypeSelectInput({dataObject, setDataObject, isLoading, disabled}) {
...
CoveritySCMToolTypeSelectInput.propTypes = {
...
export default CoveritySCMToolTypeSelectInput;