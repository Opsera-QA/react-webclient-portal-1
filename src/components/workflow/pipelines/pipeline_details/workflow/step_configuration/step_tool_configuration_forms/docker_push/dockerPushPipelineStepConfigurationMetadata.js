const dockerPushPipelineStepConfigurationMetadata = {
  type: "Docker Push Pipeline Step Configuration",
  fields: [
    {
      label: "Step Tool",
      id: "toolConfigId",
...
export default dockerPushPipelineStepConfigurationMetadata