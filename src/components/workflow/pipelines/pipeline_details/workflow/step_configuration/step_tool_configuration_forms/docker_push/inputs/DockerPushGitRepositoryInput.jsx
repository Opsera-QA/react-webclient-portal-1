...
function DockerPushGitRepositoryInput({dataObject, setDataObject, disabled}) {
...
DockerPushGitRepositoryInput.propTypes = {
  dataObject: PropTypes.object,
  setDataObject: PropTypes.func,
  disabled: PropTypes.bool,
};

export default DockerPushGitRepositoryInput;