...
import SonarComplianceThresholdInputRow from "./SonarComplianceThresholdInputRow";

function SonarStepComplianceThresholdInput(
  {
    fieldName,
    model,
    setModel,
        ...
        {thresholdRows.map((threshold, index) => {
          return (
            <div key={index} className={index % 2 === 0 ? "odd-row" : "even-row"}>
              <SonarComplianceThresholdInputRow
                disabled={disabled}
                index={index}
...
SonarStepComplianceThresholdInput.propTypes = {
...
SonarStepComplianceThresholdInput.defaultProps = {
  fieldName: "thresholdCompliance",
  visible: true,
  className: "mb-3",
};

export default SonarStepComplianceThresholdInput;
