...
function DockerPushJenkinsAccountInput({dataObject, setDataObject, disabled, className}) {
...
DockerPushJenkinsAccountInput.propTypes = {
...
export default DockerPushJenkinsAccountInput;