...
function AzureCliStepApplicationSelectInput({fieldName, model, setModel, azureToolId}) {
...
AzureCliStepApplicationSelectInput.propTypes = {
...
AzureCliStepApplicationSelectInput.defaultProps = {
  fieldName: "azureCredentialId",
};

export default AzureCliStepApplicationSelectInput;
