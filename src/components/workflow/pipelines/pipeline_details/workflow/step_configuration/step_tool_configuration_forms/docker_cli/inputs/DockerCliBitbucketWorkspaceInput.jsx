...
function DockerCliBitbucketWorkspaceInput({model, setModel, disabled}) {
...
DockerCliBitbucketWorkspaceInput.propTypes = {
  model: PropTypes.object,
  setModel: PropTypes.func,
  disabled: PropTypes.bool,
};

export default DockerCliBitbucketWorkspaceInput;
