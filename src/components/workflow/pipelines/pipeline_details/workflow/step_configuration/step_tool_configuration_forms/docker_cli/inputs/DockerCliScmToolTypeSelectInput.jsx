...
function DockerCliScmToolTypeSelectInput({model, setModel, isLoading, disabled}) {
...
DockerCliScmToolTypeSelectInput.propTypes = {
...
export default DockerCliScmToolTypeSelectInput;
