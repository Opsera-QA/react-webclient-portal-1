...
import anchoreStepFormMetadata from "./anchore-stepForm-metadata";
...
function AnchoreStepConfiguration({ stepTool, plan, stepId, parentCallback, getToolsList }) {
  ...
  const loadFormData = async (step) => {
    ...
    if (typeof configuration !== "undefined") {
      setAnchoreStepConfigurationDataDto(new Model(configuration, anchoreStepFormMetadata, false));
      ...
      setAnchoreStepConfigurationDataDto(
        new Model({ ...anchoreStepFormMetadata.newModelBase }, anchoreStepFormMetadata, false)
      );
    }
  };
