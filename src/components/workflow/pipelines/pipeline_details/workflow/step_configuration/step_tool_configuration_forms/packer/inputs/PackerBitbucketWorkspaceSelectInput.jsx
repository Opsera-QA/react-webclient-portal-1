...
function PackerBitbucketWorkspaceSelectInput({model, setModel, disabled}) {
...
PackerBitbucketWorkspaceSelectInput.propTypes = {
  model: PropTypes.object,
  setModel: PropTypes.func,
  disabled: PropTypes.bool,
};

export default PackerBitbucketWorkspaceSelectInput;
