...
function ArgoCDStepConfiguration( { stepTool, pipelineId, plan, stepId, parentCallback, callbackSaveToVault, setToast, setShowToast }) {
  ...
  const searchArgoList = async (service) => {  
    ...
    try {
      ...
      if( res.data ) {
        ...
        let errorMessage = "Argo information is missing or unavailable!  Please ensure the required Cypress creds are registered and up to date in Tool Registry.";
      }
    } catch (error) {
