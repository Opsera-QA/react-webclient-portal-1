...
function AnchoreIntegratorStepConfigurationDeprecated({ stepTool, pipelineId, plan, stepId, parentCallback, callbackSaveToVault, setToast, setShowToast }) {
...
AnchoreIntegratorStepConfigurationDeprecated.propTypes = {
...
export default AnchoreIntegratorStepConfigurationDeprecated;
