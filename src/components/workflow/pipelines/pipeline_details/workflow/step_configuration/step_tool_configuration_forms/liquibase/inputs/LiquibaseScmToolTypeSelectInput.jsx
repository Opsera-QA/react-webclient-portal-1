...
function LiquibaseScmToolTypeSelectInput({model, setModel, isLoading, disabled}) {
...
LiquibaseScmToolTypeSelectInput.propTypes = {
...
export default LiquibaseScmToolTypeSelectInput;
