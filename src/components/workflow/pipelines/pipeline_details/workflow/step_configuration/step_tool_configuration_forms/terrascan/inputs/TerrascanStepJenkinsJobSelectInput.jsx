...
function TerrascanStepJenkinsJobSelectInput({model, setModel, disabled}) {
...
TerrascanStepJenkinsJobSelectInput.propTypes = {
  model: PropTypes.object,
  setModel: PropTypes.func,
  disabled: PropTypes.bool,
};

export default TerrascanStepJenkinsJobSelectInput;