const anchoreIntegratorStepConfigurationMetadata = {
  ...
  fields: [
    ...
    },
    {
      ...
      id: "ecrPushStepId",
      isRequired: true,
      formText: "This step must the corresponding ECR/Docker step being used in order to retrieve the Docker Image URL generated by that step. If this is not selected properly the job may fail."
    }
  ],
  newObjectFields: {
    anchoreToolConfigId: "",
