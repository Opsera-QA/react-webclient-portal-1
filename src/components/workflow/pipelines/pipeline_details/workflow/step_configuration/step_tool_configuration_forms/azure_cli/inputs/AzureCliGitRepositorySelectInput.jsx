...
function AzureCliGitRepositorySelectInput({model, setModel, disabled}) {
...
AzureCliGitRepositorySelectInput.propTypes = {
  model: PropTypes.object,
  setModel: PropTypes.func,
  disabled: PropTypes.bool,
};

export default AzureCliGitRepositorySelectInput;
