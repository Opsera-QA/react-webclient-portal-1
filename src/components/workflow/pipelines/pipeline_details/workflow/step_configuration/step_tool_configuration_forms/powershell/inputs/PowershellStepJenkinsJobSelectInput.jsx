...
function PowershellStepJenkinsJobSelectInput({model, setModel, disabled}) {
...
PowershellStepJenkinsJobSelectInput.propTypes = {
  model: PropTypes.object,
  setModel: PropTypes.func,
  disabled: PropTypes.bool,
};

export default PowershellStepJenkinsJobSelectInput;