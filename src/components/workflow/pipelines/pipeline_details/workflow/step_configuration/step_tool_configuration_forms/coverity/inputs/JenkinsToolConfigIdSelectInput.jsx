...
function JenkinsToolSelectInput({ fieldName, dataObject, setDataObject, disabled, textField, valueField, tool_prop }) {
...
JenkinsToolSelectInput.propTypes = {
...
JenkinsToolSelectInput.defaultProps = {
  valueField: "id",
  textField: "name",
  fieldName: "toolConfigId",
};

export default JenkinsToolSelectInput;
