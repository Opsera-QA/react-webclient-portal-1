...
import FreeTrialConfirmTaskWorkflowDeletionButton from "components/wizard/free_trial/workflows/flows/tasks/deletion/FreeTrialConfirmTaskWorkflowDeletionButton";
  ...
  useEffect(() => {
    if (setButtonContainer) {
      setButtonContainer(
        ...
        >
          <FreeTrialConfirmTaskWorkflowDeletionButton
    ...
    <div className={className}>
      <CenteredContentWrapper>
        <div className={"d-flex m-3"}>
          ...
          <H5FieldSubHeader
            className={"mb-3"}
            subheaderText={`Are you sure you would like to delete this Task? `}
          />
        </div>
      </CenteredContentWrapper>
      <CenteredContentWrapper>
        <div>Data cannot be recovered once this Task is deleted.</div>
      </CenteredContentWrapper>
    </div>
  );
}

FreeTrialDeleteTaskWorkflowConfirmationScreen.propTypes = {
