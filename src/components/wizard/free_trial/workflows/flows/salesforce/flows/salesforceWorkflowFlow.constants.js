...
salesforceWorkflowFlowConstants.SALESFORCE_FLOW_OPTION_LABELS = {
  SALESFORCE_ORGANIZATION_SYNC: "Salesforce Organization Sync",
  SALESFORCE_ORGANIZATION_SYNC_WITH_UNIT_TESTING: "Salesforce Organization Sync",
  SALESFORCE_ORGANIZATION_SYNC_WITH_UNIT_TESTING_AND_BACKUP: "Salesforce Organization Sync",
...
salesforceWorkflowFlowConstants.SALESFORCE_FLOW_OPTION_SUBTITLES = {
  ...
  SALESFORCE_ORGANIZATION_SYNC_WITH_UNIT_TESTING: "Include Unit Testing",
  SALESFORCE_ORGANIZATION_SYNC_WITH_UNIT_TESTING_AND_BACKUP: "Include Unit Testing and Backup Option",
  SALESFORCE_ORGANIZATION_SYNC_TASK: "",
  SALESFORCE_PROFILE_MIGRATION: "Basic",
  SALESFORCE_PROFILE_MIGRATION_ORGANIZATION_SYNC: "Organization Sync",
  SALESFORCE_TO_GIT_MERGE_SYNC: "",
};
