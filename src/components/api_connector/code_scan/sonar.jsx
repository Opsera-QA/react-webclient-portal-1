...
function Sonar() {
  ...
  async function getData() {
    ...
    new ApiService(
      apiServerUrl + "/connectors/sonar/settings",
      null,
      accessToken,
      urlParams).get()
      .then(response => {
  ...
  const handleSave = async (e) => {
    ...
    if (state.update) {
      ...
      new ApiService(
        apiServerUrl + "/connectors/sonar/update",
        null,
        accessToken,
        urlParams).post()
        .then(response => {
      ...
      new ApiService(
        apiServerUrl + "/connectors/sonar/createHook",
        null,
        accessToken,
        urlParams).post()
        .then(response => {
  ...
  return (
    <div>
      ...
      <Card className="mt-3">
        <Card.Header as="h5">SonarQube Credentials </Card.Header>
        <Card.Body>
          ...
          {!fetching &&
            <Form onSubmit={handleSave}>
              ...
              <Form.Group controlId="formGridUsername">
                <Form.Label>SonarQube Username</Form.Label>
                <Form.Control
                  type="text"
                  placeholder=""
                  name="username"
