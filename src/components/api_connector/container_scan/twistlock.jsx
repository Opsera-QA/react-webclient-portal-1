...
function Twistlock() {
  ...
  async function getData() {
    ...
    new ApiService(
      apiServerUrl + "/connectors/twistlock/settings",
      null,
      accessToken,
      urlParams).get()
      .then(response => {
  ...
  const handleSave = async (e) => {
    ...
    if (state.update) {
      ...
      new ApiService(
        apiServerUrl + "/connectors/twistlock/update",
        null,
        accessToken,
        urlParams).post()
        .then(response => {
      ...
      new ApiService(
        apiServerUrl + "/connectors/twistlock/createHook",
        null,
        accessToken,
        urlParams).post()
        .then(response => {
  ...
  return (
    <div>
      ...
      <Card className="mt-3">
        <Card.Header as="h5">Twistlock Credentials </Card.Header>
        <Card.Body>
          ...
          {!fetching &&
            <Form onSubmit={handleSave}>
              ...
              <Form.Group controlId="formGridUsername">
                <Form.Label>Twistlock Username</Form.Label>
                <Form.Control
                  type="text"
                  placeholder=""
                  name="username"
