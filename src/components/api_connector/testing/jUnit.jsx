...
function JUnit() {
  ...
  async function getData() {
    ...
    new ApiService(
      apiServerUrl + "/connectors/junit/settings",
      null,
      accessToken,
      urlParams).get()
      .then(response => {
  ...
  const handleSave = async (e) => {
    ...
    if (state.update) {
      ...
      new ApiService(
        apiServerUrl + "/connectors/junit/update",
        null,
        accessToken,
        urlParams).post()
        .then(response => {
      ...
      new ApiService(
        apiServerUrl + "/connectors/junit/createHook",
        null,
        accessToken,
        urlParams).post()
        .then(response => {
  ...
  return (
    <div>
      ...
      <Card className="mt-3">
        <Card.Header as="h5">jUnit Credentials </Card.Header>
        <Card.Body>
