...
function Selenium() {
  ...
  async function getData() {
    ...
    new ApiService(
      apiServerUrl + "/connectors/selenium/settings",
      null,
      accessToken,
      urlParams).get()
      .then(response => {
  ...
  const handleSave = async (e) => {
    ...
    if (state.update) {
      ...
      new ApiService(
        apiServerUrl + "/connectors/selenium/update",
        null,
        accessToken,
        urlParams).post()
        .then(response => {
      ...
      new ApiService(
        apiServerUrl + "/connectors/selenium/createHook",
        null,
        accessToken,
        urlParams).post()
        .then(response => {
  ...
  return (
    <div>
      ...
      <Card className="mt-3">
        <Card.Header as="h5">Selenium Credentials </Card.Header>
        <Card.Body>
          ...
          {!fetching &&
            <Form onSubmit={handleSave}>
              ...
              <Form.Group controlId="formGridUsername">
                <Form.Label>jUnit Username</Form.Label>
                <Form.Control
                  type="text"
                  placeholder=""
                  name="username"
