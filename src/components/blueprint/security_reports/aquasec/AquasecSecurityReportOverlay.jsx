...
import AquasecSecurityReportTable from "components/blueprint/security_reports/aquasec/AquasecSecurityReportTable";
import IconBase from "components/common/icons/IconBase";

function AquasecSecurityReportOverlay({ aquasecSecurityVulnerabilities, stats }) {
  ...
  return (
    <FullScreenCenterOverlayContainer
      ...
      showPanel={true}
      titleText={"Aquasec Security Report"}
      titleIcon={faFileCode}
    >
      <div className={"p-3"}>
        {getDataBlocks()}
        <AquasecSecurityReportTable
          aquasecSecurityVulnerabilities={aquasecSecurityVulnerabilities}
        />
      </div>
    </FullScreenCenterOverlayContainer>
  );
...
AquasecSecurityReportOverlay.propTypes = {
  aquasecSecurityVulnerabilities: PropTypes.array,
  stats: PropTypes.object,
};

export default AquasecSecurityReportOverlay;
