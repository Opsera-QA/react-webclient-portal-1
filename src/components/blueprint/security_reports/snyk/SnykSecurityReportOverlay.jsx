...
import SnykOpenSourceScanSecurityReportTable from "components/blueprint/security_reports/snyk/SnykOpenSourceScanSecurityReportTable";
import SnykSastScanSecurityReportTable from "components/blueprint/security_reports/snyk/SnykSastScanSecurityReportTable";
import IconBase from "components/common/icons/IconBase";

function SnykSecurityReportOverlay({ snykSecurityVulnerabilities, stats }) {
  ...
  return (
    <FullScreenCenterOverlayContainer
      ...
      showPanel={true}
      titleText={"Snyk Security Report"}
      titleIcon={faFileCode}
    >
      <div className={"p-3"}>
        {getDataBlocks()}
        <SnykOpenSourceScanSecurityReportTable
          snykSecurityVulnerabilities={snykSecurityVulnerabilities?.openSourceScanReport}
        />
        <SnykSastScanSecurityReportTable
          snykSecurityVulnerabilities={snykSecurityVulnerabilities?.sastScanReport}
        />
      </div>
    </FullScreenCenterOverlayContainer>
  );
...
SnykSecurityReportOverlay.propTypes = {
  snykSecurityVulnerabilities: PropTypes.array,
  stats: PropTypes.object,
};

export default SnykSecurityReportOverlay;
