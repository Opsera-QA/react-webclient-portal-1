...
import BlackduckSecurityReportTable from "components/blueprint/security_reports/blackduck/BlackduckSecurityReportTable";
import IconBase from "components/common/icons/IconBase";

function BlackduckSecurityReportOverlay({ blackduckSecurityVulnerabilities, stats }) {
  ...
  return (
    <FullScreenCenterOverlayContainer
      ...
      showPanel={true}
      titleText={"Blackduck Security Report"}
      titleIcon={faFileCode}
    >
      <div className={"p-3"}>
        {getDataBlocks()}
        <BlackduckSecurityReportTable
          blackduckSecurityVulnerabilities={blackduckSecurityVulnerabilities}
        />
      </div>
    </FullScreenCenterOverlayContainer>
  );
...
BlackduckSecurityReportOverlay.propTypes = {
  blackduckSecurityVulnerabilities: PropTypes.array,
  stats: PropTypes.object,
};

export default BlackduckSecurityReportOverlay;
