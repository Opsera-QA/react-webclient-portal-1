...
import CoveritySecurityReportTable from "components/blueprint/security_reports/coverity/CoveritySecurityReportTable";
import IconBase from "components/common/icons/IconBase";

function CoveritySecurityReportOverlay({ coveritySecurityVulnerabilities, stats }) {
  ...
  return (
    <FullScreenCenterOverlayContainer
      ...
      showPanel={true}
      titleText={"Coverity Security Report"}
      titleIcon={faFileCode}
    >
      <div className={"p-3"}>
        {getDataBlocks()}
        <CoveritySecurityReportTable
          coveritySecurityVulnerabilities={coveritySecurityVulnerabilities}
        />
      </div>
    </FullScreenCenterOverlayContainer>
  );
...
CoveritySecurityReportOverlay.propTypes = {
  coveritySecurityVulnerabilities: PropTypes.array,
  stats: PropTypes.object,
};

export default CoveritySecurityReportOverlay;
