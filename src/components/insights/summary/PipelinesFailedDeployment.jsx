...
function PipelineFailedDeployment({dashboardData}) {
  ...
  const loadData = async (cancelSource = cancelTokenSource, filterDto = tableFilterDto) => {
    try {
      ...
      const response = await chartsActions.parseConfigurationAndGetChartMetrics(getAccessToken, cancelSource, "summaryPipelinesFailedDeployment", null, dashboardTags, filterDto, null, dashboardOrgs);
  ...
  const getChartBody = () => {
    return (
      <DataBox 
        ...
        toolTip="Pipelines Failing Deployment Step"
