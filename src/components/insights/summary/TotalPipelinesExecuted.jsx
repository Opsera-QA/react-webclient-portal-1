...
function TotalPipelinesExecuted({dashboardData}) {
  ...
  const loadData = async (cancelSource = cancelTokenSource, filterDto = tableFilterDto) => {
    try {
      ...
      const response = await chartsActions.parseConfigurationAndGetChartMetrics(getAccessToken, cancelSource, "summaryTotalPipelines", null, dashboardTags, filterDto, null, dashboardOrgs);
  ...
  const getChartBody = () => {
    return (
      <DataBox 
        ...
        toolTip="Total Number of Pipelines Executed"
