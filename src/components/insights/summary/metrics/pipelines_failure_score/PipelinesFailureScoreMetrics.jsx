...
import ExecutedPipelineTotalMetric from "components/insights/summary/metrics/pipelines_overview/total_executed/ExecutedPipelineTotalMetric";
import SuccessfulPipelineRunTotalMetric from "components/insights/summary/metrics/pipelines_overview/successful_executions/SuccessfulPipelineRunTotalMetric";
import TotalPipelinesFailed from "components/insights/summary/metrics/pipelines_overview/total_failed/FailedPipelineRunTotalMetric";
...
import FailedPipelineQualityAndSecurityMetric from "components/insights/summary/metrics/pipelines_failure_score/failed_quality_and_security/FailedPipelineQualityAndSecurityMetric";
import PipelinesFailedDeployment from "components/insights/summary/metrics/pipelines_failure_score/failed_deployment/FailedPipelineDeploymentMetric";
import StoppedPipelines from "components/insights/summary/metrics/pipelines_failure_score/stopped_pipelines/StoppedPipelineCountMetric";
