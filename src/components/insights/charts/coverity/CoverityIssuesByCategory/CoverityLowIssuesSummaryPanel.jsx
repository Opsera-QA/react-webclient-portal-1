...
import CoverityLowIssuesMetaData from "components/insights/charts/coverity/CoverityIssuesByCategory/CoverityLowIssuesMetaData";
import genericChartFilterMetadata from "components/insights/charts/generic_filters/genericChartFilterMetadata";
import { DialogToastContext } from "contexts/DialogToastContext";
import BlueprintLogOverlay from "../../../../blueprint/BlueprintLogOverlay";

function CoverityLowIssuesSummaryPanel({ dashboardData, kpiConfiguration, setActiveTab }) {
  // const history = useHistory();
  const toastContext = useContext(DialogToastContext);
  const fields = CoverityLowIssuesMetaData.fields;
  ...
  const [tableFilterDto, setTableFilterDto] = useState(
    new Model({ ...genericChartFilterMetadata.newObjectFields }, CoverityLowIssuesMetaData, false)
  );
  ...
  const columns = useMemo(
    () => [
      ...
      getChartTrendStatusColumn(getField(fields, "lowTrend")),
    ],
    []
  );
...
CoverityLowIssuesSummaryPanel.propTypes = {
...
export default CoverityLowIssuesSummaryPanel;
