...
import { getChartTrendStatusColumn, getLimitedTableTextColumn, getTableDateTimeColumn, getTableTextColumn } from "components/common/table/table-column-helpers";
import { getField } from "components/common/metadata/metadata-helpers";
import Model from "core/data_model/model";
import chartsActions from "components/insights/charts/charts-actions";
import CoverityMediumIssuesMetaData from "components/insights/charts/coverity/CoverityIssuesByCategory/CoverityMediumIssuesMetaData";
import genericChartFilterMetadata from "components/insights/charts/generic_filters/genericChartFilterMetadata";
import { DialogToastContext } from "contexts/DialogToastContext";
import BlueprintLogOverlay from "../../../../blueprint/BlueprintLogOverlay";

function CoverityMediumIssuesSummaryPanel({ dashboardData, kpiConfiguration, setActiveTab }) {
  // const history = useHistory();
  const toastContext = useContext(DialogToastContext);
  const fields = CoverityMediumIssuesMetaData.fields;
  ...
  const [tableFilterDto, setTableFilterDto] = useState(
    new Model({ ...genericChartFilterMetadata.newObjectFields }, CoverityMediumIssuesMetaData, false)
  );
  ...
  const columns = useMemo(
    () => [
      ...
      getChartTrendStatusColumn(getField(fields, "mediumTrend")),
    ],
    []
  );
...
CoverityMediumIssuesSummaryPanel.propTypes = {
...
export default CoverityMediumIssuesSummaryPanel;
