...
function GitScrapperActionableDataBlockContainers({ data, level }) {
...
GitScrapperActionableDataBlockContainers.propTypes = {
  data: PropTypes.object,
  level: PropTypes.string,
};

export default GitScrapperActionableDataBlockContainers;
