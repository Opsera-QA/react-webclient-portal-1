...
import GitScrapperMetricIssuesScorecardMetaData from "components/insights/charts/gitscrapper/actionable_insights/card/issues/actionable_insights/gitScrapperMetricScorecardMetaData";
        ...
        <small>
          <Row className="d-flex align-items-center">            
            ...
            <Col sm={12} md={7} lg={9}>
                <Row>
                    <Col sm={12} md={6} lg={6}>
                        <TextFieldBase dataObject={gitScrapperMetricScorecardDto} fieldName={"author"} className="insight-detail-label my-2" />
                    </Col>
                    <Col sm={12} md={6} lg={6}>
                        <TextFieldBase dataObject={gitScrapperMetricScorecardDto} fieldName={"path"} className="insight-detail-label my-2" />
                    </Col>
                    <Col sm={12} md={6} lg={6}>
                        <TextFieldBase dataObject={gitScrapperMetricScorecardDto} fieldName={"commit"} className="insight-detail-label my-2" />
                    </Col>
                    <Col sm={12} md={6} lg={6}>
                      <TextFieldBase dataObject={gitScrapperMetricScorecardDto} fieldName={"commitHash"} className="insight-detail-label my-2" />
                    </Col>
                </Row>
            </Col>            
          </Row>          
