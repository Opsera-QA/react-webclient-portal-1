...
function ApigeeReportsEditorPanel(
  {
    metricModel,
    unpackedFilterData,
    metricFilterModel,
  ...
  useEffect(() => {
    ...
    if (unpackedFilterData) {
      setMetricFilterModel(modelHelpers.parseObjectIntoModel(unpackedFilterData, apigeeReportsMetadata));
    }
...
ApigeeReportsEditorPanel.propTypes = {
...
export default ApigeeReportsEditorPanel;
