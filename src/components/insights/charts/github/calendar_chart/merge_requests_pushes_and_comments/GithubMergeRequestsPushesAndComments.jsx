...
function GithubMergeRequestsPushesAndComments({ persona, date, tags }) {
  ...
  const fetchData = useCallback(async () => {
    ...
    const postBody = {
      request: "githubTotalCountOfMergeReqAndPushPerDay",
    ...
    try {
      ...
      let dataObject = res && res.data ? res.data.data[0].githubTotalCountOfMergeReqAndPushPerDay : [];
      setData(dataObject);
      setLoading(false);
    } catch (err) {
