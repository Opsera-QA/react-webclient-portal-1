...
import { githubCommitsByAuthorMetadata } from "./githubCommitsByAuthor.metadata";

function GithubCommitsByAuthorEditorPanel({
  metricModel,
  unpackedFilterData,
  metricFilterModel,
...
GithubCommitsByAuthorEditorPanel.propTypes = {
...
export default GithubCommitsByAuthorEditorPanel;
