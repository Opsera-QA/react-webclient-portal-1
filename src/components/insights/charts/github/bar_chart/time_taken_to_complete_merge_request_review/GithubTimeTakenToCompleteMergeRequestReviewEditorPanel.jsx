...
import { githubTimeTakenToCompleteMergeRequestReviewMetadata } from "./githubTimeTakenToCompleteMergeRequestReview.metadata";

function GithubTimeTakenToCompleteMergeRequestReviewEditorPanel({
  metricModel,
  unpackedFilterData,
  metricFilterModel,
    ...
    if (unpackedFilterData) {
      setMetricFilterModel(
        modelHelpers.parseObjectIntoModel(
          unpackedFilterData,
          githubTimeTakenToCompleteMergeRequestReviewMetadata,
        ),
      );
    }
  }, [unpackedFilterData]);
...
GithubTimeTakenToCompleteMergeRequestReviewEditorPanel.propTypes = {
...
export default GithubTimeTakenToCompleteMergeRequestReviewEditorPanel;
