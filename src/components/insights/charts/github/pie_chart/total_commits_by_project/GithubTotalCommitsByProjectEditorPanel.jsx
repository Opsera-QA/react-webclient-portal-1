...
import { githubTotalCommitsByProjectMetadata } from "./githubTotalCommitsByProject.metadata";

function GithubTotalCommitsByProjectEditorPanel({
  metricModel,
  unpackedFilterData,
  metricFilterModel,
    ...
    if (unpackedFilterData) {
      setMetricFilterModel(
        modelHelpers.parseObjectIntoModel(
          unpackedFilterData,
          githubTotalCommitsByProjectMetadata,
        ),
      );
    }
  }, [unpackedFilterData]);
...
GithubTotalCommitsByProjectEditorPanel.propTypes = {
...
export default GithubTotalCommitsByProjectEditorPanel;
