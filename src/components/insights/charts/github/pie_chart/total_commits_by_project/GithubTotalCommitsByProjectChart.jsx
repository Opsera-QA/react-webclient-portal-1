...
function GithubTotalCommitsByProjectChart({ persona, date, tags }) {
  ...
  const fetchData = async () => {
    ...
    const postBody = {
      request: "githubTotalCommitsChart",
    ...
    try {
      ...
      let dataObject = res && res.data ? res.data.data[0].githubTotalCommitsChart : [];
      setData(dataObject);
      setLoading(false);
    } catch (err) {
...
GithubTotalCommitsByProjectChart.propTypes = {
