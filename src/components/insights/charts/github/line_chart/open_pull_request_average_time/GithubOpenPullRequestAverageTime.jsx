...
function GithubOpenPullRequestAverageTime({
    ...
    const loadData = async (cancelSource = cancelTokenSource) => {
        try {
            ...
            let dataObject = response?.data?.githubPullRequestAverageOpenTime?.data[0]?.chartData;
            let datablock = response?.data?.githubPullRequestAverageOpenTime?.data[0]?.statisticsData;
