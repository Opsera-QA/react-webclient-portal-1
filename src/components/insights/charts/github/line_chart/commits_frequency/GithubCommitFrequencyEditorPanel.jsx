...
import {githubCommitFrequencyMetadata} from "./githubCommitFrequency.metadata";
import {hierarchyFiltersMetadata} from "components/insights/dashboards/hierarchy-filters-metadata.js";
import chartsActions from "components/insights/charts/charts-actions";

function GithubCommitFrequencyEditorPanel(
  {
    metricModel,
    unpackedFilterData,
    metricFilterModel,
  ...
  useEffect(() => {
    ...
    if (unpackedFilterData) {
      ...
      setMetricFilterModel(modelHelpers.parseObjectIntoModel(unpackedFilterData, githubCommitFrequencyMetadata));
    }
...
GithubCommitFrequencyEditorPanel.propTypes = {
...
export default GithubCommitFrequencyEditorPanel;
