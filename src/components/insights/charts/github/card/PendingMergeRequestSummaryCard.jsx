...
import githubPendingMergeRequestsMetadata from "../table/pending_merge_requests/github-pending-merge-requests-metadata";
...
function RecentMergeRequestSummaryCard({ mergeRequestData, loadData }) {
  ...
  const initializeDto = async () => 
    setMergeRequestMetricScorecardDto(new Model({...mergeRequestData}, githubPendingMergeRequestsMetadata, false));
