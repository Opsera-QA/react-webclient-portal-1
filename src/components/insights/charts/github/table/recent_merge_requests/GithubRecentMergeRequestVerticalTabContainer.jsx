...
import githubRecentMergeRequestsMetadata from "./github-recent-merge-requests-metadata";

function GithubRecentMergeRequestVerticalTabContainer ({ handleTabClick, dashboardData, kpiConfiguration, activeTab }) {
    ...
    const [tableFilterDto, setTableFilterDto] = useState(new Model({ ...githubRecentMergeRequestsMetadata.newObjectFields }, githubRecentMergeRequestsMetadata, false));
...
GithubRecentMergeRequestVerticalTabContainer.propTypes = {
...
export default GithubRecentMergeRequestVerticalTabContainer;
