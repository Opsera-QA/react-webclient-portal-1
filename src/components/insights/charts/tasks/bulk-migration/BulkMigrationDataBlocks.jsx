...
import { BULK_MIGRATION_METRIC_CONSTANTS } from "./BulkMigration_kpi_datapoint_identifiers";
import { getTrendForBlocks } from '../utils';

function BulkMigrationDataBlocks({
  kpiConfiguration,
  dashboardData,
  setError,
}) {
  ...
  const loadData = async (cancelSource = cancelTokenSource) => {
    try {
      ...
      const res =
        await TasksActions.bulkMigrationKPIDataBlocks(
          kpiConfiguration,
          getAccessToken,
          cancelSource,
          dashboardTags,
...
BulkMigrationDataBlocks.propTypes = {
  kpiConfiguration: PropTypes.object,
  dashboardData: PropTypes.object,
  setError: PropTypes.func,
};

export default BulkMigrationDataBlocks;
