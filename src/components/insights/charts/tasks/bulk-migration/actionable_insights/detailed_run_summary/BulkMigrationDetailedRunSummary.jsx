...
import BulkMigrationDetailedRunSummaryTable from "./BulkMigrationDetailedRunSummaryTable";
import { metricHelpers } from "components/insights/metric.helpers";
import useComponentStateReference from "hooks/useComponentStateReference";
import taskActions from "../../tasks-actions";
import {bulkMigrationMetadata} from "../../bulkMigration.metadata";

export default function BulkMigrationDetailedRunSummary(
  {
    kpiConfiguration,
    dashboardData,
    dashboardFilters,
  ...
  const loadData = async (filterDto = filterModel) => {
    try {
      ...
      const response = await taskActions.bulkMigrationActionableOneTable(
        kpiConfiguration,
        getAccessToken,
        cancelTokenSource,
        filterDto,
  ...
  return (
    <BulkMigrationDetailedRunSummaryTable
      data={metrics}
      isLoading={isLoading}
      loadData={loadData}
...
BulkMigrationDetailedRunSummary.propTypes = {
