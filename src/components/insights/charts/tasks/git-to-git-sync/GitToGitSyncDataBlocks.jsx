...
import { GIT_TO_GIT_SYNC_METRIC_CONSTANTS } from "./GitToGitSync_kpi_datapoint_identifiers";
import { getTrendForBlocks } from '../utils';

function GitToGitSyncDataBlocks({
  kpiConfiguration,
  dashboardData,
  setError,
}) {
...
GitToGitSyncDataBlocks.propTypes = {
  kpiConfiguration: PropTypes.object,
  dashboardData: PropTypes.object,
  setError: PropTypes.func,
};

export default GitToGitSyncDataBlocks;
