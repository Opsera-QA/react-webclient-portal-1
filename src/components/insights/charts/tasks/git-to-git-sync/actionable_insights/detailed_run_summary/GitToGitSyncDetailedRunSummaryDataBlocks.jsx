...
function GitToGitSyncDetailedRunSummaryDataBlocks(
  {
    kpiConfiguration,
    dashboardData,
    dashboardFilters,
  ...
  const loadData = async () => {
    try {
      ...
      const response = await taskActions.gitToGitSyncActionableOneDataBlocks(
        kpiConfiguration,
        getAccessToken,
        cancelTokenSource,
        dashboardTags,
...
GitToGitSyncDetailedRunSummaryDataBlocks.propTypes = {
...
export default GitToGitSyncDetailedRunSummaryDataBlocks;
