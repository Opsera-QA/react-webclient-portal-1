...
function SalesforceToGitMergeSyncUniqueRunSummaryDataBlocks(
  {
    kpiConfiguration,
    dashboardData,
    selectedRunObject,
...
SalesforceToGitMergeSyncUniqueRunSummaryDataBlocks.propTypes = {
  kpiConfiguration: PropTypes.object,
  dashboardData: PropTypes.object,
  selectedRunObject: PropTypes.object,
};

export default SalesforceToGitMergeSyncUniqueRunSummaryDataBlocks;
