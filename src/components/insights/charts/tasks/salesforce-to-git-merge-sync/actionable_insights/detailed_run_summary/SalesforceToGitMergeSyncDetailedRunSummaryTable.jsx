...
export default function SalesforceToGitMergeSyncDetailedRunSummaryTable({
  ...
  const onRowSelect = (rowData) => {
    ...
    setCurrentScreen(
      SALESFORCE_TO_GIT_MERGE_SYNC_ACTIONABLE_INSIGHT_SCREENS.SALESFORCE_TO_GIT_MERGE_SYNC_COMPONENT_SUMMARY,
    );
  };
...
SalesforceToGitMergeSyncDetailedRunSummaryTable.propTypes = {
