...
import TotalUniqueComponents from "../../../data-blocks/TotalUniqueComponents/TotalUniqueComponents";
import taskActions from "../../tasks-actions";

function SalesforceToGitMergeSyncDetailedRunSummaryDataBlocks(
  {
    kpiConfiguration,
    dashboardData,
    dashboardFilters,
  ...
  const loadData = async () => {
    try {
      ...
      const response = await taskActions.sfdcToGitMergeSyncActionableOneDataBlocks(
        kpiConfiguration,
        getAccessToken,
        cancelTokenSource,
        dashboardTags,
  ...
  return (
    <div className={"px-3"}>
      <Row style={{ justifyContent: "space-evenly" }}>
        ...
        <TotalComponentsDeployed score={metrics?.details?.[0]?.totalComponentsDeployed || 'N/A'} />
        ...
        <TotalUniqueComponents score={metrics?.unique?.[0]?.uniqueFiles || 'N/A'} />
      </Row>
    </div>
  );
}

SalesforceToGitMergeSyncDetailedRunSummaryDataBlocks.propTypes = {
...
export default SalesforceToGitMergeSyncDetailedRunSummaryDataBlocks;
