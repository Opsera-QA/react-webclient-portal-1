...
import { SALESFORCE_TO_GIT_MERGE_SYNC_METRIC_CONSTANTS } from "./SalesforceToGitMergeSync_kpi_datapoint_identifiers";
import { getTrendForBlocks } from '../utils';

function SalesforceToGitMergeSyncDataBlocks({
  kpiConfiguration,
  dashboardData,
  setError,
}) {
  ...
  const loadData = async (cancelSource = cancelTokenSource) => {
    try {
      ...
      const res =
        await TasksActions.sfdcToGitMergeSyncKPIDataBlocks(
          kpiConfiguration,
          getAccessToken,
          cancelSource,
          dashboardTags,
...
SalesforceToGitMergeSyncDataBlocks.propTypes = {
  kpiConfiguration: PropTypes.object,
  dashboardData: PropTypes.object,
  setError: PropTypes.func,
};

export default SalesforceToGitMergeSyncDataBlocks;
