...
import { getTableTextColumn, getStaticIconColumn, getTableDurationTextColumn, getTaskStatusColumnWithoutRunCount, getTableDateTimeColumn } from "components/common/table/table-column-helpers";
...
import SalesforceToGitMergeSyncActionableInsightOverlay
  from "./actionable_insights/SalesforceToGitMergeSyncActionableInsightOverlay";
...
function SalesforceToGitMergeBottomTable(
  ...
  const fields = salesforceToGitMergeSyncMetadata.fields;
  ...
  const onRowSelect = (rowData) => {
    toastContext.showInfoOverlayPanel(
      <SalesforceToGitMergeSyncActionableInsightOverlay
...
SalesforceToGitMergeBottomTable.propTypes = {
...
export default SalesforceToGitMergeBottomTable;
