...
import SalesforceOrgSyncBottomTable from "./SalesforceOrgSyncBottomTable";
import { salesforceOrgSyncMetadata } from "./salesforceOrgSync.metadata";

function SalesforceOrgSyncTableOverlay({ kpiConfiguration, dashboardData }) {
  ...
  const loadData = async (cancelSource = cancelTokenSource, filterDto = filterModel) => {
    try {
      ...
      const response = await taskActions.sfdcOrgSyncBaseKPITable(
        kpiConfiguration,
        getAccessToken,
        cancelSource,
        filterDto,
...
SalesforceOrgSyncTableOverlay.propTypes = {
  kpiConfiguration: PropTypes.object,
  dashboardData: PropTypes.object,
};

export default SalesforceOrgSyncTableOverlay;
