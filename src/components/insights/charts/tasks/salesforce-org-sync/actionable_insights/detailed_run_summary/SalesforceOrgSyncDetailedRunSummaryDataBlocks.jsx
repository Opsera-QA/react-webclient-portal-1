...
function SalesforceOrgSyncDetailedRunSummaryDataBlocks(
  {
    kpiConfiguration,
    dashboardData,
    dashboardFilters,
  ...
  const loadData = async () => {
    try {
      ...
      const response = await taskActions.sfdcOrgSyncActionableOneDataBlocks(
        kpiConfiguration,
        getAccessToken,
        cancelTokenSource,
        dashboardTags,
...
SalesforceOrgSyncDetailedRunSummaryDataBlocks.propTypes = {
...
export default SalesforceOrgSyncDetailedRunSummaryDataBlocks;
