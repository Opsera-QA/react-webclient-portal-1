...
import { sonarRatingsMetricsMetadata } from "./sonarRatingMetrics.metadata";

function SonarRatingMetricsEditorPanel(
  {
    metricModel,
    unpackedFilterData,
    metricFilterModel,
  ...
  useEffect(() => {
    ...
    if (unpackedFilterData) {
      setMetricFilterModel(modelHelpers.parseObjectIntoModel(unpackedFilterData, sonarRatingsMetricsMetadata));
    }
...
SonarRatingMetricsEditorPanel.propTypes = {
...
export default SonarRatingMetricsEditorPanel;
