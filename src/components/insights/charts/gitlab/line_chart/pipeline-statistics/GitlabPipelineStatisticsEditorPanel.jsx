    ...
    if (unpackedFilterData) {
      setMetricFilterModel(
        modelHelpers.parseObjectIntoModel(
          unpackedFilterData,
          gitlabPipelineStatisticsMetadata,
        ),
      );
    }
  }, [unpackedFilterData]);
...
GitlabPipelineStatisticsEditorPanel.propTypes = {
...
export default GitlabPipelineStatisticsEditorPanel;
