...
function GitLabLeadTimeChartV2({
  kpiConfiguration,
  setKpiConfiguration,
  dashboardData,
  index,
  ...
  const loadData = async (cancelSource = cancelTokenSource) => {
    try {
      ...
      if(selectedDeploymentStages) {
        const response = await gitlabAction.gitlabLeadTimeForChangeV2(
          getAccessToken,
          cancelSource,
          kpiConfiguration,
          dashboardTags,
...
GitLabLeadTimeChartV2.propTypes = {
...
export default GitLabLeadTimeChartV2;
