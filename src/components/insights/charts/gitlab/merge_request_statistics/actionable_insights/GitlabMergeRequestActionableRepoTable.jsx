...
function GitlabMergeRequestActionableRepoTable({ data, isLoading, loadData, filterModel, setFilterModel, priority, tableTitleIcon, count, range }) {
...
GitlabMergeRequestActionableRepoTable.propTypes = {
...
export default GitlabMergeRequestActionableRepoTable;