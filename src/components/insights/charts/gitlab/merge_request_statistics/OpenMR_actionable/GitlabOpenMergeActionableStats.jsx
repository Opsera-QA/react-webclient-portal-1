...
function GitlabOpenMergeActionableStats({ kpiConfiguration, dashboardData }) {
  ...
  const loadData = async (cancelSource = cancelTokenSource) => {
    try {
      ...
      const response = await gitlabAction.getStatsOpenActionable(
        getAccessToken,
        cancelSource,
        kpiConfiguration,
        dashboardTags,
  ...
  return <div>{getChartBody()}</div>;
}

GitlabOpenMergeActionableStats.propTypes = {
  kpiConfiguration: PropTypes.object,
  dashboardData: PropTypes.object,
};

export default GitlabOpenMergeActionableStats;
