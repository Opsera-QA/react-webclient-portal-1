...
function GitlabOpenMergeActionableReviewerTable({ data, isLoading, loadData, filterModel, setFilterModel, priority, tableTitleIcon, count, range }) {
...
GitlabOpenMergeActionableReviewerTable.propTypes = {
...
export default GitlabOpenMergeActionableReviewerTable;