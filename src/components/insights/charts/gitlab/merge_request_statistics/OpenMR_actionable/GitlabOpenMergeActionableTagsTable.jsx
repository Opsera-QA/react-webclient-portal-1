...
function GitlabOpenMergeActionableTagsTable({ data, isLoading, loadData, filterModel, setFilterModel, priority, tableTitleIcon, count, range }) {
...
GitlabOpenMergeActionableTagsTable.propTypes = {
...
export default GitlabOpenMergeActionableTagsTable;