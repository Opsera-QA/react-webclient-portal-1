...
import GitlabMergeRequestActionableReviewerTable from "./GitlabOpenMergeActionableReviewerTable";

function GitlabOpenMergeActionableReviewerOverlay({ kpiConfiguration, dashboardData, range, icon}) {
    ...
    const loadData = async (cancelSource = cancelTokenSource, filterDto = filterModel) => {
        try {
            ...
            const response = await gitlabAction.getReviewerOpenActionable(
                getAccessToken,
                cancelSource,
                kpiConfiguration,
                dashboardTags,
...
GitlabOpenMergeActionableReviewerOverlay.propTypes = {
...
export default GitlabOpenMergeActionableReviewerOverlay;