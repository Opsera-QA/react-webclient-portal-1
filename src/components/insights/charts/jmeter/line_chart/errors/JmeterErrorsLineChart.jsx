...
function JMeterErrorsLineChart({ persona, date, tags }) {
  ...
  const getApiData = async () => {
    ...
    try {
      ...
      let dataObject = res && res.data ? res.data.data[0].jmeterErrorsLineChart : [];
      setData(dataObject);
      setLoading(false);
    } catch (err) {
...
export default JMeterErrorsLineChart;
