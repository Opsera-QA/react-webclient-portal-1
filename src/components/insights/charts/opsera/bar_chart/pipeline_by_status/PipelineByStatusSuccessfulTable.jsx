...
function PipelineByStatusSuccessfulTable({ dashboardData, kpiConfiguration, setActiveTab, currentDate }) {
  ...
  const loadData = async (cancelSource = cancelTokenSource, filterDto = tableFilterDto) => {
    try {
      ...
      const response = await chartsActions.parseConfigurationAndGetChartMetrics(getAccessToken, cancelSource, "listOfSuccessfulRuns", null, dashboardTags, filterDto, null, null, null, currentDate);
...
PipelineByStatusSuccessfulTable.propTypes = {
