...
export default function GithubActionsDetailedWorkflowSummaryTable({
  ...
  const onRowSelect = (rowData) => {
    ...
    setCurrentScreen(
      GITHUB_ACTIONS_WORKFLOW_ACTIONABLE_INSIGHT_SCREENS.GITHUB_ACTIONS_WORKFLOW_UNIQUE_RUN_SUMMARY,
    );
  };
    ...
    <div>
      <div className={"p-2"}>
        <div className={"d-flex details-title-text"}>
          ...
          <div className={"mr-4"}>
            <b>Successful Repository With Most Time Consuming Runs:</b>{" "}
            {mostSuccessTime}
          </div>
          <div className={"mr-4"}>
            <b>Failed Repository With Most Time Consuming Runs:</b>{" "}
            {mostFailedTime}
          </div>
        </div>
      </div>
