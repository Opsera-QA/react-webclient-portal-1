...
import ExportGithubActionWorkflowReportActionableInsights3Panel from "components/insights/charts/github_actions/workflows/export/ExportGithubActionsWorkflowReportActionableInsights3Panel";
    ...
    <div className={"mx-3"}>
      <div className={"p-2"}>
        <div className={"d-flex details-title-text"}>
          ...
          <div className={"mr-4"}>
            <b>Step With Most Time Consuming Successful Runs:</b>{" "}
            {mostSuccessTime}
          </div>
          <div className={"mr-4"}>
