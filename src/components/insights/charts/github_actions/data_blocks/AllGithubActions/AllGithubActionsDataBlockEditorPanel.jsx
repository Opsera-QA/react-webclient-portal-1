...
function AllGithubActionsDataBlockEditorPanel(
  {
    metricModel,
    unpackedFilterData,
    metricFilterModel,
  ...
  useEffect(() => {
    ...
    if (unpackedFilterData) {
      ...
      setMetricFilterModel(modelHelpers.parseObjectIntoModel(newUnpackedFilterData, allGithubActionsDataBlockMetadata));
    }
...
AllGithubActionsDataBlockEditorPanel.propTypes = {
...
export default AllGithubActionsDataBlockEditorPanel;
