...
function SuccessExecutionsDetailedActionableInsights({ repositoryName, actionName, headCommitSha, kpiConfiguration, dashboardData}) {
  ...
  const noDataMessage = "Success Executions Detailed report is currently unavailable at this time";
  ...
  const getSuccessDetailedBlocks = () => {
    return (
...
SuccessExecutionsDetailedActionableInsights.propTypes = {
...
export default SuccessExecutionsDetailedActionableInsights;