...
export function getDateObjectFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "date")
    ]?.value
  ) {
    return {
      start:
  ...
  return {
    start: new Date(
      addDays(new Date(), -15).setHours(0, 0, 0, 0),
    ).toISOString(),
...
export function getTagsFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "tags")
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "tags")
    ]?.value.length > 0
...
export function getJenkinsResultFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "jenkins-result")
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "jenkins-result")
    ]?.value.length > 0
...
export function getJenkinsBuildNumberFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
        (obj) => obj.type === "jenkins-build-number",
      )
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
...
export function getJiraIssueComponentsFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
        (obj) => obj.type === "jira-issue-components",
      )
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
...
export function getJiraIssueLabelsFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
        (obj) => obj.type === "jira-issue-labels",
      )
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
...
export function getJiraIssueStatusFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
        (obj) => obj.type === "jira-issue-status",
      )
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
...
export function getJiraIssueStartStatusFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
        (obj) => obj.type === "jira-issue-start-status",
      )
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
...
export function getJiraIssueDoneStatusFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
        (obj) => obj.type === "jira-issue-done-status",
      )
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
...
export function getSonarProjectKeyFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
        (obj) => obj.type === "sonar-project-key",
      )
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
...
export function getDomainFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "domain")
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "domain")
    ]?.value.length > 0
...
export function getApplicationFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "application")
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "application")
    ]?.value.length > 0
...
export function getReleaseFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "release")
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "release")
    ]?.value.length > 0
...
export function getSprintFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "sprint")
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "sprint")
    ]?.value.length > 0
...
export function getProjectFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "project")
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "project")
    ]?.value.length > 0
...
export function getSeleniumTestSuitesFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
        (obj) => obj.type === "selenium-test-suites",
      )
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
...
export function getSonarProjectLanguagesFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
        (obj) => obj.type === "sonar-project-languages",
      )
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
...
export function getGitlabProjectFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "gitlab-project")
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex((obj) => obj.type === "gitlab-project")
    ]?.value.length > 0
...
export function getServiceNowPrioritiesFromKpiConfiguration(kpiConfiguration) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
        (obj) => obj.type === "servicenow-priorities",
      )
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
...
export function getServiceNowAssignmentGroupsFromKpiConfiguration(
  kpiConfiguration,
) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
        (obj) => obj.type === "servicenow-assignment-groups",
      )
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
...
export function getServiceNowServiceOfferingsFromKpiConfiguration(
  kpiConfiguration,
) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
        (obj) => obj.type === "servicenow-service-offerings",
      )
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
...
export function getServiceNowConfigurationItemsFromKpiConfiguration(
  kpiConfiguration,
) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
        (obj) => obj.type === "servicenow-configuration-items",
      )
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
...
export function getServiceNowBusinessServicesFromKpiConfiguration(
  kpiConfiguration,
) {
  if (
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
        (obj) => obj.type === "servicenow-business-services",
      )
    ]?.value &&
    kpiConfiguration?.filters[
      kpiConfiguration.filters.findIndex(
