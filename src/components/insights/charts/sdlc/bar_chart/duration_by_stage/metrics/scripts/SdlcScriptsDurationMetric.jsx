...
function SdlcScriptsDurationMetric({ kpiConfiguration, dashboardData, meanData, countData, goalsData, metric }) {
  const getDataBlock = () => {
    const scriptsDataPoint = dataPointHelpers.getDataPoint(kpiConfiguration?.dataPoints,
      constants.SUPPORTED_DATA_POINT_IDENTIFIERS.SCRIPTS_DURATION_DATA_POINT);
    return (
