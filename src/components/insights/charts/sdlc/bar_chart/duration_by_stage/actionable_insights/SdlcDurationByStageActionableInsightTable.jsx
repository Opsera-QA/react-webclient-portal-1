...
import SonarPipelineTableMetadata from "./sdlc-duration-by-stage-metadata";
import { getTableTextColumn, getTableTextColumnWithoutField, getTableDurationTextColumn } from "components/common/table/table-column-helpers";
...
function SdlcDurationByStageActionableInsightTable({ data, isLoading, loadData, filterModel, setFilterModel, title }) {
  const toastContext = useContext(DialogToastContext);
  const fields = SonarPipelineTableMetadata.fields;
  const tableTitle = "SDLC " + title + " Report";
  const noDataMessage = "SDLC " + title + " report is currently unavailable at this time";
...
SdlcDurationByStageActionableInsightTable.propTypes = {
...
export default SdlcDurationByStageActionableInsightTable;
