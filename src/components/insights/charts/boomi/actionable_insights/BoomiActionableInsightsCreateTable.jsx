...
function BoomiActionableInsightsCreateTable({ data, isLoading, loadData, filterModel, setFilterModel, title }) {
...
BoomiActionableInsightsCreateTable.propTypes = {
...
export default BoomiActionableInsightsCreateTable;