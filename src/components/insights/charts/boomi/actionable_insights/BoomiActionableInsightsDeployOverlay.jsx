...
function BoomiActionableInsightDeployOverlay({ kpiConfiguration, dashboardData }) {
    ...
    return (
        <div className={"p-3"}>
            ...
            {getDataBlocks()}
            <BoomiActionableInsightsDeployTable
                isLoading={isLoading}
                data={actionableData}
...
BoomiActionableInsightDeployOverlay.propTypes = {
    kpiConfiguration: PropTypes.object,
    dashboardData: PropTypes.object,
};

export default BoomiActionableInsightDeployOverlay;