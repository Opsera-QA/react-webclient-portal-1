...
import BoomiActionableInsightTable from "../BoomiActionableInsightTable";
import BoomiActionableDataBlocks from "../BoomiActionableDataBlocks";
import IconBase from "components/common/icons/IconBase";

function BoomiMasterTab({ priority, dashboardData, kpiConfiguration, icon }) {
  ...
  return (
    <div className={"p-2"}>
      <BoomiActionableDataBlocks data={dataBlockValues}  />
      <BoomiActionableInsightTable
        data={metrics}
        isLoading={isLoading}
        loadData={loadData}
...
BoomiMasterTab.propTypes = {
  priority: PropTypes.number,
  dashboardData: PropTypes.object,
  kpiConfiguration: PropTypes.object,
  icon: PropTypes.object,
};
export default BoomiMasterTab;
