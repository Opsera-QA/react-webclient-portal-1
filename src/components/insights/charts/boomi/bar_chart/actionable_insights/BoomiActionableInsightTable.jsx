...
function BoomiActionableInsightTable({ data, isLoading, loadData, filterModel, setFilterModel, priority, tableTitleIcon }) {
...
BoomiActionableInsightTable.propTypes = {
...
export default BoomiActionableInsightTable;