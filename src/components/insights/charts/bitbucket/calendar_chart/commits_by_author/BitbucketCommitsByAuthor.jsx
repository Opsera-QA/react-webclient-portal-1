...
function BitbucketCommitsByAuthor({ persona, date, tags }) {
  ...
  const fetchData = useCallback(async () => {
    ...
    const postBody = {
      request: "bitbucketTotalCommitsByUserAndDate",
    ...
    try {
      ...
      let dataObject = res && res.data ? res.data.data[0].bitbucketTotalCommitsByUserAndDate : [];
