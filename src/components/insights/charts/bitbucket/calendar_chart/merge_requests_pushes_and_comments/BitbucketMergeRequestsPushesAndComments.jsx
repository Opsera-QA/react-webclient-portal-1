...
function BitbucketMergeRequestsPushesAndComments({ persona, date, tags }) {
  ...
  const fetchData = useCallback(async () => {
    ...
    const postBody = {
      request: "bitbucketTotalCountOfMergeReqAndPushPerDay",
    ...
    try {
      ...
      let dataObject = res && res.data ? res.data.data[0].bitbucketTotalCountOfMergeReqAndPushPerDay : [];
      setData(dataObject);
      setLoading(false);
    } catch (err) {
