...
function BitbucketMostActiveContributors({ date, tags }) {
  ...
  async function fetchData() {
    ...
    const postBody = {
      request: "bitbucketMostActiveUsers",
    ...
    try {
      ...
      setData(dataObject);
      setLogCount(dataObject.bitbucketMostActiveUsers.data.length);
      setLoading(false);
    } catch (err) {
      setErrors(err);
      setLoading(false);
  ...
  if (
    typeof data !== "object" ||
    data.bitbucketMostActiveUsers === undefined ||
    data.bitbucketMostActiveUsers.status !== 200
  )
    return (
    ...
    <>
      ...
      data.bitbucketMostActiveUsers.status !== 200 ? (
        ...
        <>
          ...
          <CustomTable
            columns={columns}
            data={data.bitbucketMostActiveUsers.data}
            rowStyling={""}
