...
function BitbucketMergeRequestByMaximumTimeChart({ persona, date, tags }) {
  ...
  const fetchData = async () => {
    ...
    const postBody = {
      request: "bitbucketMergeReqWithMaximumTime",
    ...
    try {
      ...
      let dataObject = res && res.data ? res.data.data[0].bitbucketMergeReqWithMaximumTime : [];
      setData(dataObject);
      setLoading(false);
    } catch (err) {
      setLoading(false);
