...
function BitbucketTimeTakenToCompleteMergeRequestReview({ persona, date, tags }) {
  ...
  const fetchData = async () => {
    ...
    const postBody = {
      request: "bitbucketTimeTakenToCompleteMergeRequestReviewChart",
    ...
    try {
      ...
      let dataObject = res && res.data ? res.data.data[0].bitbucketTimeTakenToCompleteMergeRequestReviewChart : [];
      setData(dataObject);
      setLoading(false);
    } catch (err) {
