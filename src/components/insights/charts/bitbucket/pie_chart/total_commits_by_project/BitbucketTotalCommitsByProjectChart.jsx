...
function BitbucketTotalCommitsByProjectChart({ persona, date, tags }) {
  ...
  const fetchData = async () => {
    ...
    const postBody = {
      request: "bitbucketTotalCommitsChart",
    ...
    try {
      ...
      let dataObject = res && res.data ? res.data.data[0].bitbucketTotalCommitsChart : [];
      setData(dataObject);
      setLoading(false);
    } catch (err) {
