...
function BitbucketPendingMergeRequests({ date, tags }) {
  ...
  async function fetchData() {
    ...
    const postBody = {
      request: "bitbucketPendingMergeRequests",
    ...
    try {
      ...
      setData(dataObject);
      setLogCount(dataObject.bitbucketPendingMergeRequests.data.length);
      setLoading(false);
    } catch (err) {
      setErrors(err);
      setLoading(false);
  ...
  return (
    <>
      {typeof data !== "object" ||
      data.bitbucketPendingMergeRequests === undefined ||
      data.bitbucketPendingMergeRequests.status !== 200 ? (
        <>
        ...
        <>
          ...
          <CustomTable
            columns={columns}
            data={data.bitbucketPendingMergeRequests.data}
            rowStyling={""}
