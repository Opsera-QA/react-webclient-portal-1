...
function SalesforceCodeAnalyserCategoryActionableTwoOverlay({
    ...
    const loadData = async (cancelSource = cancelTokenSource, filterDto = filterModel) => {
        try {
            ...
            const response = await codeAnalyserActions.salesforceCodeAnalyserCategoryActionableTwo(
                getAccessToken,
                cancelSource,
                kpiConfiguration,
                dashboardTags,
    ...
    return (
        ...
        >
            <div className={"p-3"}>
                {getDateRange()}
                <SalesforceCodeAnalyserCategoryActionableTwoTable
                    isLoading={isLoading}
                    data={metrics}
...
SalesforceCodeAnalyserCategoryActionableTwoOverlay.propTypes = {
    kpiConfiguration: PropTypes.object,
    dashboardData: PropTypes.object,
    category: PropTypes.string,
};

export default SalesforceCodeAnalyserCategoryActionableTwoOverlay;