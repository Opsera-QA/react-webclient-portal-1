...
chartsActions.approvalGates = async(getAccessToken, cancelTokenSource,kpiConfiguration, dashboardTags, dashboardOrgs, tableFilterDto)=>{
  const date = getDateObjectFromKpiConfiguration(kpiConfiguration);
  const apiUrl = "analytics/v1/approvalGates";
  let tags = getTagsFromKpiConfiguration(kpiConfiguration);
