...
chartsActions.parseConfigurationAndGetChartMetrics = async (getAccessToken, cancelTokenSource, request, kpiConfiguration, dashboardTags, tableFilterDto, projectTags) => {
  const apiUrl = "/analytics/metrics";
  const date = getDateObjectFromKpiConfiguration(kpiConfiguration);
