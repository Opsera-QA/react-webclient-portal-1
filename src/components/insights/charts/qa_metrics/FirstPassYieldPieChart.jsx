...
function ManualQaTestPieChart({ kpiConfiguration, setKpiConfiguration, dashboardData, index, setKpis, showSettingsToggle }) {
  ...
  const loadData = async (cancelSource = cancelTokenSource) => {
    try {
      ...
      const response = await chartsActions.parseConfigurationAndGetChartMetrics(getAccessToken, cancelSource, "firstPassYield", kpiConfiguration, dashboardTags, null, null, dashboardOrgs, null, null, dateRange);
