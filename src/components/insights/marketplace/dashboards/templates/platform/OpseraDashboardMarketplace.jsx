...
import OpseraDashboardMarketplaceDashboardTemplateCardView from "components/insights/marketplace/dashboards/templates/platform/OpseraDashboardMarketplaceDashboardTemplateCardView";
...
function OpseraDashboardMarketplace () {
  ...
  const getDashboardTemplates = async (filterModel = dashboardTemplateFilterModel) => {
    const response = await platformDashboardTemplateActions.getPlatformDashboardTemplatesV2(
      getAccessToken,
      cancelTokenSource,
      filterModel,
    );
  ...
  const getMainBody = () => {
    return (
      <OpseraDashboardMarketplaceDashboardTemplateCardView
        loadData={loadData}
        isLoading={isLoading}
  ...
  return (
    <FilterContainer
      ...
      title={"Opsera Marketplace Dashboard Templates"}
      className={"pb-2"}
    />
  );
}

OpseraDashboardMarketplace.propTypes = {};

export default OpseraDashboardMarketplace;
