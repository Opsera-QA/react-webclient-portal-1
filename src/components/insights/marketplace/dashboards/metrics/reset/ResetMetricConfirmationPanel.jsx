...
import ResetMetricOptionsEditorPanel from "components/insights/marketplace/dashboards/metrics/reset/ResetMetricOptionsEditorPanel";
  ...
  const resetKpiData = async () => {
    try {
      ...
      if (resetKpiModel.getData("internalProperties") === true) {
        ...
        metricModel?.setData("dashboardNotifications", defaultKpiConfiguration?.dashboardNotificationsEnabled);
