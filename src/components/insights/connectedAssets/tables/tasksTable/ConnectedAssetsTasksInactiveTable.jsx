...
function ConnectedAssetsTasksInactiveTable({ dashboardData }) {
  ...
  const loadRecentPipelineData = async (cancelSource = cancelTokenSource, filterDto = filterModel) => {
    ...
    const response = await connectedAssetsActions.getTasksInfo(
      getAccessToken,
      cancelSource,
      constants.TASKS_LIST.INACTIVE_TASKS,
      dateRange?.startDate,
      dateRange?.endDate,
      filterDto,
    );
...
ConnectedAssetsTasksInactiveTable.propTypes = {
  dashboardData: PropTypes.object,
};
export default ConnectedAssetsTasksInactiveTable;