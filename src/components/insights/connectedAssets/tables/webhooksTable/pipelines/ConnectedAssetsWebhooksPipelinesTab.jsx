...
import ConnectedAssetsWebhooksPipelinesTable from "./ConnectedAssetsWebhooksPipelinesTable";
import PaginationContainer from "../../../../../common/pagination/PaginationContainer";
import { CONNECTED_ASSETS_CONSTANTS as constants } from "../../../connecetdAssets.constants";

function ConnectedAssetsWebhooksPipelinesTab({ dashboardData }) {
    ...
    return (
      <>
        <VanitySetTabAndViewContainer
          className={"mb-3"}
          title={`List of Webhooks from Pipelines`}
...
ConnectedAssetsWebhooksPipelinesTab.propTypes = {
  dashboardData: PropTypes.object,
};

export default ConnectedAssetsWebhooksPipelinesTab;
