...
function DependencyAnalyserFileUploadScreen({ pipelineWizardModel, setPipelineWizardModel, setPipelineWizardScreen, handleClose }) {
  ...
  return (
    <div>
      <div className="my-2">
        Select components using a CSV file or upload a Package XML file to use for dependency analyser.
      </div>
      <div>
        <ExternalPageLink
...
DependencyAnalyserFileUploadScreen.propTypes = {
...
export default DependencyAnalyserFileUploadScreen;
