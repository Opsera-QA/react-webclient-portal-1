...
import DependencyAnalyserSubmitSelectedFilesButton from "./DependencyAnalyserSubmitSelectedFilesButton";

const DependencyAnalyserModifiedFileViewer = ({ pipelineWizardModel, setPipelineWizardModel, setPipelineWizardScreen, handleClose, }) => {
  ...
  return (
    <div>
      ...
      <SaveButtonContainer>
        <Button variant="secondary" size="sm" className="mr-2" onClick={() => {setPipelineWizardScreen(DEPENDENCY_ANALYSER_SCREENS.COMPONENT_SELECTOR);}}>
          <IconBase icon={faArrowLeft} className={"mr-1"}/>Back
        </Button>
        <DependencyAnalyserSubmitSelectedFilesButton
          setPipelineWizardScreen={setPipelineWizardScreen}
          pipelineWizardModel={pipelineWizardModel}
...
DependencyAnalyserModifiedFileViewer.propTypes = {
...
export default DependencyAnalyserModifiedFileViewer;