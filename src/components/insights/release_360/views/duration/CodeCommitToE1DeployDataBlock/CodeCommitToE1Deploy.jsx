...
import CodeCommitToE1DeployMetaData from "./code-commit-to-E1-deploy";
...
function CodeCommitToE1Deploy() {
  ...
  const [tableFilterDto, setTableFilterDto] = useState(
    new Model({ ...genericChartFilterMetadata.newObjectFields }, CodeCommitToE1DeployMetaData, false)
  );
  ...
  const getBody = () => {
    ...
    return (
      <FilterContainer
        // isLoading={isLoading}
        showBorder={false}
        title={`Code Commit to E1 Deploy`}
  ...
  const onRowSelect = () => {
    toastContext.showOverlayPanel(
      <FullScreenCenterOverlayContainer
        ...
        showPanel={true}
        titleText={`Code Commit to E1 Deploy`}
        showToasts={true}
        titleIcon={faTable}
        isLoading={false}
  ...
  return (
    <ThreeLineDataBlockBase
      ...
      className={"p-2"}
      topText={"Code Commit to E1 Deploy"}
      middleText={
