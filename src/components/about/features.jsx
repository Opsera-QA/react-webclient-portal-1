      ...
      <div>
        <Card className="mt-4">
          ...
          <Card.Body>
            ...
            <Button variant="outline-primary" className="ml-2" onClick={() => this.gotoLink('pipeline')}>Configure Pipeline</Button>
            <Button variant="outline-primary" className="ml-2" onClick={() => this.gotoLink('platform')}>Register Application</Button>
