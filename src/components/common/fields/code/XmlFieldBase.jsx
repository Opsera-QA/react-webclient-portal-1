...
function XmlFieldBase({model, fieldName, className, isLoading}) {
  ...
  const loadData = async () => {
    try {
      const formattedXml = formatXml(model.getData(fieldName));
