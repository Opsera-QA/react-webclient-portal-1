...
function TextInputWithValidationBase(
  {
    fieldName,
    dataObject,
    setDataObject,
  ...
  const getInputIcon = () => {
    if (isValid === true) {
      return (
        <IconBase icon={faCheckCircle} className="text-input-icon green" fixedWidth/>
      );
    } else if (isValid === false) {
      return (
        <IconBase icon={faTimesCircle} className="text-input-icon red" fixedWidth/>
      );
    }
  };
  ...
  const getInputBody = () => {
    return (
      <input
        ...
        autoComplete={"off"}
        onBlur={validateDataFunction}
        onFocus={clearIsValidFunction}
      />
    );
  };
...
TextInputWithValidationBase.propTypes = {
  ...
  clearIsValidFunction: PropTypes.func,
};

export default TextInputWithValidationBase;
