...
function EndpointRequestFieldNameTextInput(
  {
    model,
    setModel,
    fieldName,
...
EndpointRequestFieldNameTextInput.propTypes = {
...
EndpointRequestFieldNameTextInput.defaultProps = {
  fieldName: "fieldName",
};

export default EndpointRequestFieldNameTextInput;