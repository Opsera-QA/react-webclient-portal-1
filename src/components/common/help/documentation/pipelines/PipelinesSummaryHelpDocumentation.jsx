        ...
        <div className={"ml-2 mb-2"}>
          <div><h5>Pipeline Summary</h5>A general overview of the selected pipeline including the name, ID, Owner, Organization, Type, Tags, Access Rules, Notes, Summary, Pipeline Run Count, Created date, Org Account, and schedule. Editing capabilities are dependent on user’s Access Rules. Edit the values containing a pencil icon.</div>
            <div className={"ml-3 mt-2"}>
              ...
              <div className={"mb-1"}><b>Start Pipeline</b> - Trigger a new pipeline run. For detailed information on the Salesforce Pipeline Wizard, view the <a href="https://docs.opsera.io/archive/opsera-pipelines/salesforce-pipeline-user-guides/salesforce-based-pipelines/salesforce-pipeline-wizard-help" target="_blank" rel="noreferrer"><b>Salesforce Pipeline Wizard Help Documentation</b>.</a>.</div>
