...
function PipelineStepNotificationConfigurationHelpDocumentation({closeHelpPanel}) {
  return (
    ...
    >
      <div className={"ml-2 mb-2"}>Each pipeline step in the workflow can be configured with notification triggers upon completion. Add a notification trigger to be notified upon Any Activity, Step Error, or Step Completion. Currently notifications can be sent via Email and Slack.</div>
      <div className={"ml-4"}>
