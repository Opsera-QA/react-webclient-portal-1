...
function DockerEcrPushStepConfigurationHelp() {
  ...
  return (
    <HelpOverlayBase
      ...
      showPanel={true}
      titleText={"Docker ECR Push Step Configuration Help"}>
      <br></br>
      <div className={"mb-1 ml-4"}> <b>Note:</b> To set up an ECS Service pipeline, there are 3 steps required in the workflow including this <b>Docker ECR Push</b> step:</div>
        <div>
      ...
      <div className={"ml-4"}>Select <b>Save</b> and proceed to setting up the next pipeline steps.</div>
    </HelpOverlayBase>
  );
}
