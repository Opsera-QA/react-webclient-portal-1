...
function ServiceNowHelpDocumentation() {
  ...
  const getHelpDocumentation = () => {
    return (
      <div>
        <div className={"ml-2 mb-2"}>A ServiceNow Step in an Opsera Pipeline will halt the running pipeline and notify the configured user in order to allow the pipeline to proceed. Approval notification follows the rules defined for overall step notification. For more detailed information on ServiceNow setup, view the <b><a href="https://docs.opsera.io/saas/servicenow-integration" target="_blank" rel="noreferrer">ServiceNow Help Documentation</a>.</b> Once the initial Step Setup is configured with the ServiceNow tool, set the following values:
        </div>
          <div className={"ml-4 mb-2"}>
            <ul style={{listStyleType: "none"}}>
              <li><b>ServiceNow Tool</b> - Choose the ServiceNow Tool registered in Opsera.</li>
  ...
  return (
    <HelpOverlayBase
      ...
      helpTopic={"ServiceNow Step Configuration"}
    />
  );
}
