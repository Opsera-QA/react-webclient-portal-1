    ...
    return (
      <div>
        ...
        <div className={"mb-1 ml-4"}>
          ...
          To view in depth documentation on task and pipeline setup, view the <a href="https://docs.opsera.io/aws-native-support/aws-ecs" target="_blank" rel="noreferrer">AWS Elastic Container Services documentation</a>.
