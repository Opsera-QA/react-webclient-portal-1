...
function AwsEcsDeployStepConfigurationHelp() {
  ...
  return (
    <HelpOverlayBase
      ...
      showPanel={true}
      titleText={"AWS ECS Deploy Step Configuration Help"}>
      <br></br>
      <div className={"mb-1 ml-4"}> <b>Note:</b> To set up an ECS Service pipeline, there are 3 steps required in the workflow including this <b>AWS ECS Deploy</b> step:</div>
      <div>
