...
function AzurePipelineStepConfigurationHelp() {
  ...
  return (
    <HelpOverlayBase
      ...
      <br></br>
      <div className={"mb-1"}>In Azure Pipeline Step Configuration, you are simply selecting values provided in the following drop down fields. Organization Name, Project Name/ID and Pipeline ID are fetched from a pipeline that has already been configured in the Azure DevOps portal. </div>
      <ul>
...
export default React.memo(AzurePipelineStepConfigurationHelp);