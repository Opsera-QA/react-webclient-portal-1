                ...
                <div>
                    ...
                    <div className={"ml-2"}>
                        ...
                        <ul style={{ listStyleType: "none" }}>
                            <li><b>Total Repositories</b> - Provides the total number of repositories split by total clean and total unclean repositories. Repositories with either No Vulnerable Commits or all Commits being marked as resolved/false positives/commit removed are also considered as clean repositories.
                            </li>
                            <li><b>Timeline</b> - Represents the new secrets that have been exposed in a time series. The default time range is 3 months. Horizontal axis for Date, Vertical axis for Issues added.</li>
                            <li><b>Top Secrets</b> - Limits to 5 commit hashes always. The top commit hashes that have the most number of secrets exposed. For a given date range, it represents the Top 5 commits that stands out with highest number of secrets.</li>
                            <li><b>Top Repositories</b> - Limits to 5 repositories. The top repositories that have the highest number of secrets exposed. For a given date range, it represents the Top 5 Repositories that stand out with highest number of secrets.</li>
                            <li><b>Top Users</b> - Limits to 5 users. The top 5 users who have contributed to exposing the most number of secrets. For a given date range, it represents the Top 5 Users whose commits have exposed highest number of secrets.</li>
                        </ul>
                        <div>
                            <div className={"mt-2"}><h5>Filters</h5></div>
                            <div> Supported filters are Date Range, Authors, Origin, Repositories, and Status.</div>
