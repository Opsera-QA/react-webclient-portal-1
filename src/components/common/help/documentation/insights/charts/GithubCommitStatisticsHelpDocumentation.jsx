        ...
        <HelpDocumentationContainer closeHelpPanel={closeHelpPanel} helpTopic={"Github Commits"}>
            <div>This chart calculates the various parameters of Github Pull Requests including:
                <ul style={{listStyleType: "none"}}>
                    ...
                    <li><b>Total Pull Requests</b> - Total count of Github Pull Requests</li>
                    <li><b>Approved Pull Requests</b> - Total number of approved Pull Requests that aren’t merged yet.</li>
                    ...
                    <li><b>Total Fixed Pull Requests</b> - Total Pull Requests that were first declined, reopened, fixed and then raised a Pull Request again.</li>
                </ul>
            </div>
