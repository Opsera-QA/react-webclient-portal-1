...
function AdoptionTestPercentageChartHelpDocumentation({closeHelpPanel}) {
  return (
    <HelpDocumentationContainer
      closeHelpPanel={closeHelpPanel}
      helpTopic={"Adoption Test Percentage"}
    >
      <div>
        <div className={"mb-2"}>This chart reflects the number of total automation tests that are automated vs manually executed.</div>
        <div>
...
AdoptionTestPercentageChartHelpDocumentation.propTypes = {
  closeHelpPanel: PropTypes.func,
};

export default React.memo(AdoptionTestPercentageChartHelpDocumentation);