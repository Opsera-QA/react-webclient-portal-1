    ...
    return (
        ...
        >
            <div>
                ...
                <div>Entropy of a plain text password is based on the quality of the password. A higher entropy denotes a stronger password.</div>
                <div className={"mt-2"}></div>
                <div>Should you need understanding on viewing/exporting Git Custodian Reports, read the <b><a href="https://docs.opsera.io/insights/kpi/git-custodian-kpi" target="_blank" rel="noreferrer">help documentation</a></b></div>
