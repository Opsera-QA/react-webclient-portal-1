...
function SonarRatingsLeadershipChartHelpDocumentation({closeHelpPanel}) {
  return (
    ...
    >
      ...
      <div className={"ml-3"}>
        <div><b>Sonar Ratings: Maintainability</b></div>
        <div className={"ml-3"}>
        ...
        <div className={"mt-1"}><b>Sonar Ratings: Code Coverage</b></div>
        <div className={"ml-3"}>
          <div><b>Line Coverage</b> - On a given line of code, line coverage depicts if the line of code was executed during the execution of unit tests. It is the density of covered lines by unit tests. <b>Line Coverage</b> = (Covered Lines/Total Number of Executable Lines)</div>
          <div><b>Unit Tests</b> - Number of unit tests executed.</div>
          <div><b>Duplicated Lines</b> - Number of lines involved in duplications. <b>Duplicated Line Density</b> = (Duplicated Lines/Lines) * 100.</div>
        </div>
        <div className={"mt-1"}><b>Code Coverage Metrics Report</b></div>
        <div className={"ml-3"}>
