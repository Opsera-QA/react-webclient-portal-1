...
function BoomiChartHelpDocumentation({closeHelpPanel}) {
  return (
    ...
    >
      <div>
        <div className={"mb-2"}>This chart reflects the number of Boomi components deployed, its frequency and success percentage. For more information view the <a href="https://docs.opsera.io/insights/kpi/boomi-pipeline-executions-kpi" target="_blank" rel="noreferrer"><b>Boomi Pipeline Executions Help Documentation</b>.</a></div>
        <div>
