...
function GithubConnectedAssetsHelpDocumentation({closeHelpPanel}) {
    return (
        <HelpDocumentationContainer
            closeHelpPanel={closeHelpPanel}
            helpTopic={"Github Connected Assets"}
        >
            <div>
...
GithubConnectedAssetsHelpDocumentation.propTypes = {
    closeHelpPanel: PropTypes.func,
};

export default React.memo(GithubConnectedAssetsHelpDocumentation);