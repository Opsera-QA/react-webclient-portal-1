...
function DoraJiraGitlabHelpDocumentation({ closeHelpPanel }) {
  return (
    <HelpDocumentationContainer closeHelpPanel={closeHelpPanel} helpTopic={"System Driven Maturity"}>
      <div>The System Driven Maturity KPI calculates the maturity levels for each DORA metric in a unified way. For more information view the <a href="https://docs.opsera.io/insights/kpi/dora-metrics/dora-jira-gitlab-rolled-up-kpi" target="_blank" rel="noreferrer"><b>Dora Jira Gitlab Rolled Up KPI Help Documentation</b>.</a>
