...
function AzureAksClusterCreationTaskHelpDocumentation({closeHelpPanel}) {
  return (
    <HelpDocumentationContainer helpTopic={"Azure AKS Cluster Creation"} closeHelpPanel={closeHelpPanel}>
      ...
      <ol>
        <li>Select <b>Azure AKS Cluster Creation</b> from the Type drop down. Once this has been selected, the following values will be available for selection:
          <ul>
