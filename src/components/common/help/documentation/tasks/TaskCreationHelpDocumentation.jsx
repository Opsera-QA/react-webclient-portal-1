      ...
      <ul>
        ...
        <li><b>Type</b> - Select a Task Type from the drop down menu to configure task details.
          <ul style={{listStyleType: "none"}}>
            ...
            <li><b>GIT: GIT to GIT Sync </b> - Use this task to sync up between 2 different Git branches and merge the changes. The resulting Merge Request can be configured to be approved by set of approvers before Merging.</li>
            <li><b>AWS: Create ECS Cluster </b> - Create an AWS Elastic Container Service Cluster template and run the task to create a cluster.</li>
            <li><b>AWS: Create ECS Service </b> - Create AWS Elastic Container Service to integrate tasks and management, then publish the containers through Opsera pipelines.</li>
            <li><b>AWS: Create Lambda Function</b> - Create an AWS Lambda Function template and run the task to create a cluster. </li>
            <li><b>Azure: Create AKS Cluster</b> - Create an AKS Cluster template and run the task to create a cluster. </li>
          </ul></li>
