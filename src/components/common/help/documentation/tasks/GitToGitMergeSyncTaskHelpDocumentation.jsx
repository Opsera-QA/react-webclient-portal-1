      ...
      <ol>
        <li>Select <b>{getTaskTypeLabel(TASK_TYPES.GIT_TO_GIT_MERGE_SYNC)}</b> from the Type drop down. Once this has been selected, the following values will be fetched for selection:
          <ul style={{listStyleType: "none"}}>
            <li><b>Salesforce Task</b> - To automatically retrieve data from the task and update a Jira ticket with the relevant information, enable the toggle and provide <b>Build Type</b>, <b>Jira Tool</b>, <b>Jira Project</b>, and <b>Jira Ticket</b>.</li>
