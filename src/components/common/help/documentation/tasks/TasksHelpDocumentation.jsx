...
function TasksHelpDocumentation() {
  ...
  const getHelpDocumentation = () => {
    return (
      <div>Create and manage the following Tasks. For more information, view the <b><a href="https://opsera.atlassian.net/l/c/cd5ujPjA" target="_blank" rel="noreferrer">Task Management Help Documentation</a></b> or click an individual task link below.
