...
function AwsLambdaFunctionCreationTaskHelpDocumentation({closeHelpPanel}) {
  return (
    <HelpDocumentationContainer helpTopic={"AWS Lambda Function Creation"} closeHelpPanel={closeHelpPanel}>
      ...
      <ol>
        <li>Select <b>AWS Lambda Function Creation</b> from the Type drop down. Once this has been selected, the following values will be fetched for selection:
