...
function AwsLambdaFunctionCreationTaskHelpDocumentation({closeHelpPanel}) {
  return (
    <HelpDocumentationContainer helpTopic={"AWS: Create Lambda Function"} closeHelpPanel={closeHelpPanel}>
      ...
      <ol>
        <li>Select <b>AWS: Create Lambda Function</b> from the Type drop down. Once this has been selected, the following values will be fetched for selection:
