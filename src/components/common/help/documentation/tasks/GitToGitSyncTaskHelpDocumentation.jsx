      ...
      <ol>
        <li>Select <b>{getTaskTypeLabel(TASK_TYPES.SYNC_GIT_BRANCHES)}</b> from the Type drop down. Once this has been selected, the following values will be fetched for selection:
          <ul style={{listStyleType: "none"}}>
            <li><b>Source Code Management Type</b> - Select a source code management tool(SCM) identifier. Choose from Gitlab, Github or Bitbucket.</li>
            <li><b>Account</b> - Select a configured source code management(SCM) Tool from the Tool Registry.</li>
