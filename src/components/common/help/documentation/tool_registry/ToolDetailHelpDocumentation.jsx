        ...
        <div>Register, track and configure your tool. Each tool contains tabs unique to its configuration needs. View the following list of commonly used tab details:</div>
          <div className={"mt-2"}>
            <ul style={{listStyleType: "none"}}>
              ...
              <li><b>Vault</b> - Vault Management. Opsera secures tokens, passwords, and other sensitive information in a Hashicorp Vault Instance. By default, Opsera uses the vault instance that is spun up for the the specific organization. Users have the option to choose whether to store information in the default Opsera provided vault or configure their own Hashicorp vault instance in the Tool Registry. This setting only applies to this tool. All other tools will use the Opsera provided default vault unless specified by the user. </li>
              ...
              <li><b>Accounts</b> - Register account credentials in the tool for use in pipelines. Option to select a configured Bitbucket, Coverity, Github or Gitlab or tool for use in pipelines.</li>
