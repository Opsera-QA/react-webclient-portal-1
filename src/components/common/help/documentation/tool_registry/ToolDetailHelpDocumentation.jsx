...
function ToolDetailHelpDocumentation() {
  ...
  const getHelpDocumentation = () => {
    return (
      <div>
        <div className={"ml-3"}>Register, track and configure your tool using the different tabs in Tool Details. Each tool contains tabs unique to its configuration needs. View the following list of the commonly used tabs:</div>
          <div className={"mt-1"}>
            ...
            <div className={"ml-3 mb-1"}>Additional tabs:</div>
            <ul style={{listStyleType: "none"}}>
              <li><b>Vault</b> - Opsera secures tokens, passwords, and other sensitive information in a Hashicorp Vault Instance. By default, Opsera uses the vault instance that is spun up for the specific organization. Users have the option to choose whether to store information in the default Opsera provided vault or configure their own Hashicorp vault instance in the Tool Registry. This setting only applies to this tool. All other tools will use the Opsera provided default vault unless specified by the user. </li>
              <li><b>Jobs</b> - Manage custom jobs to be triggered in pipeline steps.</li>
              <li><b>Repositories</b> - Manage tool repositories by configuring SCM tool.</li>
              ...
              <li><b>Accounts</b> - Register account credentials in the tool for use in pipelines.</li>
