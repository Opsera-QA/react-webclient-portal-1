...
export const INFORMATICA_INTELLIGENT_CLOUD_SERVICE_TYPE_LABELS = {
  ...
  MAPPLET: "Mapplet",
  MAPPLET_POWERCENTER: "Mapplet(PowerCenter)",
...
export const getInformaticaIntelligentCloudServiceTypeLabel = (iicsType) => {
  switch (iicsType) {
    ...
    case INFORMATICA_INTELLIGENT_CLOUD_SERVICE_TYPES.MAPPLET_POWERCENTER:
      return INFORMATICA_INTELLIGENT_CLOUD_SERVICE_TYPE_LABELS.MAPPLET_POWERCENTER;
...
export const INFORMATICA_INTELLIGENT_CLOUD_SERVICE_TYPE_SELECT_OPTIONS = [
  ...
  {
    text: INFORMATICA_INTELLIGENT_CLOUD_SERVICE_TYPE_LABELS.MAPPLET_POWERCENTER,
    value: INFORMATICA_INTELLIGENT_CLOUD_SERVICE_TYPES.MAPPLET_POWERCENTER,
  },
  {
