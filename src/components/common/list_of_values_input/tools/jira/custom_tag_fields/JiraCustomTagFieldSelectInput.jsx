...
function JiraCustomTagFieldSelectInput(
  {
    fieldName,
    jiraToolId,
    projectKey,    
  ...
  const loadCustomTagFields = async (cancelSource = cancelTokenSource) => {
    const response = await jiraActions.getJiraCustomTagFields(getAccessToken, cancelSource, jiraToolId, projectKey);
...
JiraCustomTagFieldSelectInput.propTypes = {
...
JiraCustomTagFieldSelectInput.defaultProps = {
  valueField: "key",
  textField: "name",
};

export default JiraCustomTagFieldSelectInput;