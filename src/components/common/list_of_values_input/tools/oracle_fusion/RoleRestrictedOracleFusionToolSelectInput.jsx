...
function RoleRestrictedOracleFusionToolSelectInput(
  {
    className,
    fieldName,
    model,
...
RoleRestrictedOracleFusionToolSelectInput.propTypes = {
...
export default RoleRestrictedOracleFusionToolSelectInput;
