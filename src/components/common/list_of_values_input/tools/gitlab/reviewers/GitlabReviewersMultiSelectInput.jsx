...
function GitlabReviewersMultiSelectInput(
    {
        fieldName,
        model,
        setModel,
    ...
    const loadReviewers = async (cancelSource = cancelTokenSource) => {
        const response = await gitlabActions.getReviewers(getAccessToken, cancelSource, toolId, repositoryId);
...
GitlabReviewersMultiSelectInput.propTypes = {
...
GitlabReviewersMultiSelectInput.defaultProps = {
    valueField: "value",
    textField: "name",
};

export default GitlabReviewersMultiSelectInput;
