...
export default function ProjectDataMappingBitbucketRepositorySelectInput(
  {
    fieldName,
    model,
    setModel,
...
ProjectDataMappingBitbucketRepositorySelectInput.propTypes = {
...
ProjectDataMappingBitbucketRepositorySelectInput.defaultProps = {
  fieldName: "key",
};
