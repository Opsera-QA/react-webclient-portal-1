...
function OrganizationSelectInput({ fieldName, dataObject, setDataObject, disabled, setDataFunction, className, clearDataFunction}) {
...
OrganizationSelectInput.propTypes = {
