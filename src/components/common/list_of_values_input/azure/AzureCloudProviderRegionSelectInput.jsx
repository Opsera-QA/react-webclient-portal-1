...
function AzureCloudProviderRegionSelectInput(
  {
    fieldName,
    model,
    setModel,
  ...
  const loadAwsRegions = async (cancelSource = cancelTokenSource) => {
    const response = await userActions.getAzureRegions(cancelSource);
...
AzureCloudProviderRegionSelectInput.propTypes = {
...
AzureCloudProviderRegionSelectInput.defaultProps = {
  valueField: "value",
  textField: "text",
};

export default AzureCloudProviderRegionSelectInput;