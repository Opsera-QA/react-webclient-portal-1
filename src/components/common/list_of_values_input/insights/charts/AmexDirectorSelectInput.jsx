...
function AmexDirectorSelectInput({
  placeholderText,
  valueField,
  textField,
  fieldName,
  ...
  const getTools = async (cancelSource = cancelTokenSource) => {
    ...
    const toolList = ["Matt Preston", "Sarah Johnson"];
...
AmexDirectorSelectInput.propTypes = {
...
AmexDirectorSelectInput.defaultProps = {
  textField: "name",
  valueField: "_id",
};

export default AmexDirectorSelectInput;
