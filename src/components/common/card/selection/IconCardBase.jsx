...
export default function IconCardBase(
  {
    children,
    isLoading,
    cardHeader,
  ...
  const getClassName = () => {
    if (hasStringValue(className) === true) {
      return `${className} card h-100 vertical-selection-card-temp`;
    }

    return `card h-100 vertical-selection-card-temp`;
  };
