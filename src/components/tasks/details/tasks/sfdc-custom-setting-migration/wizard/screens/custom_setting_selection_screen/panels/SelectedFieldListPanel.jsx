...
function SelectedFieldListPanel({
  selectedMembers,
  setSelectedMembers,
  nonMembers,
  setNonMembers,
  ...
  const formatUser = (user, index) => {
    return (
      ...
      >
        <FieldItemCard
          selectedFields={selectedMembers}
          setSelectedFields={setSelectedMembers}
          field={user}
        />
      </div>
    );
...
SelectedFieldListPanel.propTypes = {
...
export default SelectedFieldListPanel;
