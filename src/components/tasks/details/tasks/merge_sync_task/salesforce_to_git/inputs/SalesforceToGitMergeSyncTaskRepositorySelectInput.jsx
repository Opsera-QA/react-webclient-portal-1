...
function SalesforceToGitMergeSyncTaskRepositorySelectInput({
  model,
  setModel,
  disabled,
}) {
...
SalesforceToGitMergeSyncTaskRepositorySelectInput.propTypes = {
  model: PropTypes.object,
  setModel: PropTypes.func,
  disabled: PropTypes.bool,
};

export default SalesforceToGitMergeSyncTaskRepositorySelectInput;
