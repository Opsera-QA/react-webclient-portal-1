...
function SalesforceToGitMergeSyncTaskBitbucketWorkspaceSelectInput({
  model,
  setModel,
  disabled,
}) {
...
SalesforceToGitMergeSyncTaskBitbucketWorkspaceSelectInput.propTypes = {
  model: PropTypes.object,
  setModel: PropTypes.func,
  disabled: PropTypes.bool,
};

export default SalesforceToGitMergeSyncTaskBitbucketWorkspaceSelectInput;
