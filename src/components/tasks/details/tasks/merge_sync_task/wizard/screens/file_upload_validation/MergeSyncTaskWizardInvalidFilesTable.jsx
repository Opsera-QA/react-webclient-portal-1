...
const MergeSyncTaskWizardInvalidFilesTable = ({ wizardModel}) => {
  ...
  const getInvalidFiles = async (cancelSource = cancelTokenSource, newFilterModel = invalidFileFilterModel) => {
    const response = await mergeSyncTaskWizardActions.getInvalidFileList(getAccessToken, cancelSource, wizardModel, newFilterModel);
...
MergeSyncTaskWizardInvalidFilesTable.propTypes = {
  wizardModel: PropTypes.object,
};

export default MergeSyncTaskWizardInvalidFilesTable;
