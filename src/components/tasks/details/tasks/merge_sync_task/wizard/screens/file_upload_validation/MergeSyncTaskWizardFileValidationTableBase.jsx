...
const MergeSyncTaskWizardFileValidationTableBase = ({ loadData, data, isLoading, paginationModel, setPaginationModel, title, filePullCompleted, reasonAvailable }) => {
...
MergeSyncTaskWizardFileValidationTableBase.propTypes = {
...
MergeSyncTaskWizardFileValidationTableBase.defaultProps = {
  reasonAvailable: false,
};

export default MergeSyncTaskWizardFileValidationTableBase;
