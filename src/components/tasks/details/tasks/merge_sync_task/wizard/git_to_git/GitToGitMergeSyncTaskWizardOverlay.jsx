...
import GitToGitMergeSyncTaskWizard from "components/tasks/details/tasks/merge_sync_task/wizard/git_to_git/GitToGitMergeSyncTaskWizard";
import GitToGitMergeSyncTaskWizardPreRunTaskScreen from "components/tasks/details/tasks/merge_sync_task/wizard/git_to_git/GitToGitMergeSyncTaskWizardPreRunTaskScreen";
...
function SalesforceToGitMergeSyncTaskWizardOverlay({ taskModel }) {
  const [currentScreen, setCurrentScreen] = useState(
    taskModel.canUpdate() ? GIT_TO_GIT_MERGE_SYNC_TASK_WIZARD_SCREENS.PRE_RUN_TASK_SCREEN : GIT_TO_GIT_MERGE_SYNC_TASK_WIZARD_SCREENS.TASK_WIZARD
  );
