...
const ScmToScmMigrationStandaloneRepositorySelectInput = ({ value,  disabled, setDataFunction, service, gitToolId, workspace, selectedRepositories, setErrorMessage }) => {
  ...
  return (
    <StandaloneSelectInput
      ...
      value={value}
      busy={isLoading}
      placeholderText="Select Source Repository"
...
ScmToScmMigrationStandaloneRepositorySelectInput.propTypes = {
...
export default ScmToScmMigrationStandaloneRepositorySelectInput;
