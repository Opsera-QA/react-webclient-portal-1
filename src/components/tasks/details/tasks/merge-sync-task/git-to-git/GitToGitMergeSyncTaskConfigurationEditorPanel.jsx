...
import { gitToGitMergeSyncTaskConfigurationMetadata } from "components/tasks/details/tasks/merge-sync-task/git-to-git/gitToGitMergeSyncTaskConfiguration.metadata";
import GitToGitMergeSyncTaskSourceControlTypeSelectInput from "components/tasks/details/tasks/merge-sync-task/git-to-git/inputs/GitToGitMergeSyncTaskSourceControlTypeSelectInput";
import GitToGitMergeSyncTaskSourceControlToolSelectInput
  from "components/tasks/details/tasks/merge-sync-task/git-to-git/inputs/GitToGitMergeSyncTaskSourceControlToolSelectInput";
import GitToGitMergeSyncTaskBitbucketWorkspaceSelectInput
  from "components/tasks/details/tasks/merge-sync-task/git-to-git/inputs/GitToGitMergeSyncTaskBitbucketWorkspaceSelectInput";
import GitToGitMergeSyncTaskRepositorySelectInput
  from "components/tasks/details/tasks/merge-sync-task/git-to-git/inputs/GitToGitMergeSyncTaskRepositorySelectInput";
import GitToGitMergeSyncTaskSourceBranchSelectInput
  from "components/tasks/details/tasks/merge-sync-task/git-to-git/inputs/GitToGitMergeSyncTaskSourceBranchSelectInput";
import GitToGitMergeSyncTaskTargetBranchSelectInput
  from "components/tasks/details/tasks/merge-sync-task/git-to-git/inputs/GitToGitMergeSyncTaskTargetBranchSelectInput";
import GitToGitMergeSyncTaskUpstreamBranchSelectInput
  from "components/tasks/details/tasks/merge-sync-task/git-to-git/inputs/GitToGitMergeSyncTaskUpstreamBranchSelectInput";
import {
