  ...
  return (
    <div className="d-flex flex-row flex-md-column sidebar">
      <div className="navbar-list">
        ...
        {state.authenticated && <NavLink className="nav-link" activeClassName="chosen" to="/platform"><FontAwesomeIcon icon={faToolbox} fixedWidth /> Platform</NavLink>}
        {state.authenticated && <NavLink className="nav-link" activeClassName="chosen" to="/pipeline"><FontAwesomeIcon icon={faStream} fixedWidth /> Pipeline</NavLink>}
