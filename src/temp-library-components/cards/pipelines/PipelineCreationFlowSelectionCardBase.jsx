...
export default function PipelineCreationFlowSelectionCardBase(
  {
    selectedFlow,
    handleFlowSelection,
    option,
  ...
  return (
    <WorkflowOptionCardBase
      ...
      subTitle={subtitle}
      icon={icon}
      iconColor={themeConstants.RESOURCE_COLORS.PIPELINES}
...
PipelineCreationFlowSelectionCardBase.propTypes = {
